...
* **Java Persistence API (JPA)** JPA is a standard interface for accessing databases in Java, providing an automatic mapping between Java classes and database tables. 
...
* `persistence.xml` : to specify JPA configuration.
