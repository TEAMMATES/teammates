...
TEAMMATES is a community that lives on its volunteers, most of whom are [students](https://teammatesv4.appspot.com/about.jsp). One of our main objectives is to help students get experience in an OSS production environment.
...
1. Decide in which role(s) you want to contribute, i.e. tester, copy-editor, etc. as specified [in this document](#roles).
