...
<<<<<<< HEAD
PMD analysis is automated when Eclipse PMD plugin is installed successfully. Simply review the report in the PMD Perspective view under `Violations Overview`.
=======
...
>>>>>>> ad0b9044a0d8a70bbe440170382ac30916ffb94c
