 ...
 * 
 */
public class SubmissionResultsForStudent {
	...
	public SubmissionResultsForStudent(String courseID, String evaluationName,
			String fromStudentName, String toStudentName, String fromStudent,
			String toStudent, String fromStudentComments, String toStudentComments,
			String teamName, float points, float pointsBumpRatio, Text justification,
