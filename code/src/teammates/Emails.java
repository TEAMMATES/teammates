...
public class Emails {
	...
	public void remindStudent(String email, String studentName,
		...
		System.out.println("send reminder to " + email);
		try {
			Session session = Session.getDefaultInstance(props, null);
			MimeMessage message = new MimeMessage(session);
			...
			message.setFrom(new InternetAddress(from));
			message.setSubject("Teammates Evaluation - Reminder " + courseID);
			message.setText("Dear " + studentName + ",\n\n"
	 ...
	 * 
	 * Subject line:
	 * [Coordinator name] sent you an invitation to register in Teammates
	 * System. 
	 * 
	...
	public void sendRegistrationKey(String email, String registrationKey,
		...
		try {
			...
			message.setFrom(new InternetAddress(from));
			message.setSubject(coordinatorName + "sent you an invitation to register in Teammates System");
			message.setText("Dear "
					+ studentName
					+ ",\n\n"
					+ "The course " + courseName + " will be using Teammates Peer-Evaluation System for peer-evaluations. " 
					+ coordinatorName + " has invited you to use the system to evaluate your team members. " 
					...
					+ "Join the course: \n"
					+ "Enter this key : " + registrationKey
					+ "\n\n"
					+ "* Now, "+ courseID + " should appear in the course list and  the names of your teammates will "
					+ "appear when you click the \"view\" link corresponding to the course. \n"
					+ "Submit pending evaluations:\n"
					+ "*Click \"Evaluations\" button at the top to check if there are any pending peer-evaluations " 
					+ "you have to submit.\n"
					+ "Please inform "+ coordinatorEmail +" if your encounter any problems  or if your team details are not correct."
