...
public class AccountsLogicTest extends BaseTestCase {
    ...
    @Test
    public void testCreateAccount_invalidEmail_throwsInvalidParametersException() throws EntityAlreadyExistsException {
        ...
        assertEquals(
                ...
                ex.getMessage());
        verify(accountsDb, times(0)).createAccount(account);
    }

    @Test
    public void testUpdateAccount_invalidEmail_throwsInvalidParametersException() throws EntityDoesNotExistException {
        ...
        assertEquals(
                "\"invalid\" is not acceptable to TEAMMATES as a/an email because it is not in the correct format. "
                        ...
                        + "cannot be empty and cannot contain spaces.",
                ex.getMessage());
        verify(accountsDb, times(0)).updateAccount(account);
    }
