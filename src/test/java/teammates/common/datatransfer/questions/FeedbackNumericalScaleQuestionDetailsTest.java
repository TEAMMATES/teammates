...
public class FeedbackNumericalScaleQuestionDetailsTest extends BaseTestCase {
    ...
    public void testValidateResponseDetails() {
        ...
        Assertions.assertEquals("Please enter a valid value. The two nearest valid values are 1.2 and 1.3.", errors.get(0));
        ...
        errors = numScaleQuestion.validateResponsesDetails(Arrays.asList(resp), 1);
        Assertions.assertEquals(1, errors.size());
        Assertions.assertEquals("Please enter a valid value. The two nearest valid values are 1.3 and 1.4.", errors.get(0));
        ...
        errors = numScaleQuestion.validateResponsesDetails(Arrays.asList(resp), 1);
        Assertions.assertEquals(1, errors.size());
        Assertions.assertEquals("Please enter a valid value. The two nearest valid values are 1.33333 and 1.33334.",
                errors.get(0));
        ...
        errors = numScaleQuestion.validateResponsesDetails(Arrays.asList(resp), 1);
        Assertions.assertEquals(1, errors.size());
        Assertions.assertEquals("5.1 is out of the range for Numerical-scale question.(min=3, max=5)", errors.get(0));
        ...
        Assertions.assertEquals("Please enter a valid value. The two nearest valid values are 3.0 and 3.7.", errors.get(0));
        Assertions.assertEquals("100 is out of the range for Numerical-scale question.(min=3, max=5)", errors.get(1));
    }
    ...
    public void testValidateQuestionDetails() {
        ...
        Assertions.assertEquals(1, errors.size());
        Assertions.assertEquals(FeedbackNumericalScaleQuestionDetails.NUMSCALE_ERROR_MIN_MAX, errors.get(0));
        ...
        errors = numScaleQuestion.validateQuestionDetails();
        Assertions.assertEquals(1, errors.size());
        Assertions.assertEquals(FeedbackNumericalScaleQuestionDetails.NUMSCALE_ERROR_STEP, errors.get(0));
        ...
        Assertions.assertEquals(2, errors.size());
        Assertions.assertEquals(FeedbackNumericalScaleQuestionDetails.NUMSCALE_ERROR_MIN_MAX, errors.get(0));
        Assertions.assertEquals(FeedbackNumericalScaleQuestionDetails.NUMSCALE_ERROR_STEP, errors.get(1));
    }
    ...
    public void testShouldChangesRequireResponseDeletion_differentMinScale_shouldReturnTrue() {
        ...
        Assertions.assertTrue(numDetails.shouldChangesRequireResponseDeletion(newNumDetails));
    }
    ...
    public void testShouldChangesRequireResponseDeletion_sameDetails_shouldReturnFalse() {
        ...
        Assertions.assertFalse(numDetails.shouldChangesRequireResponseDeletion(newNumDetails));
    }
}
