...
public class FeedbackTextQuestionDetailsTest extends BaseTestCase {
    ...
    public void testShouldChangesRequireResponseDeletion() {
        ...
        Assertions.assertFalse(feedbackTextQuestionDetails.shouldChangesRequireResponseDeletion(updatedFeedbackTextQuestionDetails));
        ...
        Assertions.assertTrue(feedbackTextQuestionDetails.shouldChangesRequireResponseDeletion(updatedFeedbackTextQuestionDetails));
    ...
    public void testValidateQuestionDetails() {
        ...
        Assertions.assertTrue(feedbackTextQuestionDetails.validateQuestionDetails().isEmpty());
        ...
        Assertions.assertEquals(expectedResult, feedbackTextQuestionDetails.validateQuestionDetails());
    ...
    public void testValidateResponsesDetails_shouldReturnEmptyList() {
        ...
        Assertions.assertTrue(feedbackTextQuestionDetails.validateResponsesDetails(responses, 0).isEmpty());

        responses.add(new FeedbackTextResponseDetails());
        Assertions.assertTrue(feedbackTextQuestionDetails.validateResponsesDetails(responses, 10).isEmpty());

        Assertions.assertTrue(feedbackTextQuestionDetails.validateResponsesDetails(responses, -100).isEmpty());
    }
    ...
    public void testValidateGiverRecipientVisibility_shouldReturnEmptyString() {
        ...
        Assertions.assertEquals("", feedbackTextQuestionDetails.validateGiverRecipientVisibility(feedbackQuestion));
    }
    ...
    public void testIsRichTextOptionTrueByDefault_shouldReturnTrue() {
        ...
        Assertions.assertTrue(feedbackQuestionDetails.getShouldAllowRichText());
    }
}
