...
public class TimeHelperTest extends BaseTestCase {
    ...
    public void testGetMidnightAdjustedInstantBasedOnZone() {
        ZoneId zoneId = ZoneId.of("UTC");
        Instant instantAt0000 = LocalDateTime.of(2015, Month.NOVEMBER, 30, 0, 0).atZone(zoneId).toInstant();
        ...
        Instant instantAt2359 = LocalDateTime.of(2015, Month.NOVEMBER, 29, 23, 59).atZone(zoneId).toInstant();
        ...
        ZoneId wrongTimeZone = ZoneId.of("Asia/Singapore");
