...
public class FieldValidatorTest extends BaseTestCase {
    ...
    public void testGetValidityInfoForNonHtmlField_unsanitizedInput_returnErrorString() {
        ...
        Assertions.assertEquals("The provided Inconsequential test field name is not acceptable to TEAMMATES as it "
    ...
    public void testGetValidityInfoForSizeCappedPossiblyEmptyString() {
        ...
        Assertions.assertEquals("",
                FieldValidator.getValidityInfoForSizeCappedPossiblyEmptyString(
                        typicalFieldName,
                        maxLength,
                        "Dr. Amy-B s/o O'br, & 2nd \t \n (alias 'JB')"), "valid: typical value");

        Assertions.assertEquals("",
                FieldValidator.getValidityInfoForSizeCappedPossiblyEmptyString(
                        typicalFieldName,
                        maxLength,
                        StringHelperExtension.generateStringOfLength(maxLength)), "valid: max length");
        ...
        Assertions.assertEquals("",
                FieldValidator.getValidityInfoForSizeCappedPossiblyEmptyString(
                        typicalFieldName,
                        maxLength,
                        emptyValue), "valid: empty");

        String untrimmedValue = " abc ";
        Assertions.assertEquals("The provided my field is not acceptable to TEAMMATES as it contains only whitespace or "
        ...
        Assertions.assertEquals("\"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\" is not acceptable to TEAMMATES "
                         + "as a/an my field because it is too long. The value of a/an my field should be no "
                         + "longer than 50 characters.",
                     FieldValidator.getValidityInfoForSizeCappedPossiblyEmptyString(typicalFieldName, maxLength,
                                                                               tooLongName), "invalid: too long");
    }
    ...
    public void testGetInvalidityInfoForFeedbackSessionName_invalid_returnSpecificErrorString() {
        ...
        Assertions.assertEquals(
                     ...
                     actual,
                    "Invalid feedback session name (too long) should return error message specific to feedback session name");
    }

    @Test
    public void testGetInvalidityInfoForRole_null_throwException() {
        Assertions.assertThrows(AssertionError.class, () -> FieldValidator.getInvalidityInfoForRole(null));
    }
    ...
    public void testGetInvalidityInfoForRole_valid_returnEmptyString() {
        ...
        Assertions.assertEquals("", actual, "Valid role should return empty string");
    }
    ...
    public void testGetInvalidityInfoForRole_invalid_returnErrorString() {
        ...
        Assertions.assertEquals(String.format(FieldValidator.ROLE_ERROR_MESSAGE, invalidRole), actual,
    ...
    public void testGetInvalidityInfoForGoogleId_null_throwException() {
        Assertions.assertThrows(AssertionError.class, () -> FieldValidator.getInvalidityInfoForGoogleId(null));
    }

    @Test
    public void testGetInvalidityInfoForGoogleId_valid_returnEmptyString() {
        String typicalId = "valid9.Goo-gle.id_";
        Assertions.assertEquals("", FieldValidator.getInvalidityInfoForGoogleId(typicalId),
                     "Valid Google ID (typical) should return empty string");

        String shortId = "e";
        Assertions.assertEquals("", FieldValidator.getInvalidityInfoForGoogleId(shortId),
                     "Valid Google ID (short) should return empty string");

        String emailAsId = "someone@yahoo.com";
        Assertions.assertEquals("", FieldValidator.getInvalidityInfoForGoogleId(emailAsId),
                     "Valid Google ID (typical email) should return empty string");

        String shortEmailAsId = "e@y.c";
        Assertions.assertEquals("", FieldValidator.getInvalidityInfoForGoogleId(shortEmailAsId),
        ...
        Assertions.assertEquals("", FieldValidator.getInvalidityInfoForGoogleId(maxLengthId),
    ...
    public void testGetInvalidityInfoForEmail_null_throwException() {
        Assertions.assertThrows(AssertionError.class, () -> FieldValidator.getInvalidityInfoForEmail(null));
    }
    ...
    public void testGetInvalidityInfoForCourseId_null_throwException() {
        Assertions.assertThrows(AssertionError.class, () -> FieldValidator.getInvalidityInfoForCourseId(null));
    }
    ...
    public void testGetInvalidityInfoForNewStartTime_valid_returnEmptyString() {
        ...
        Assertions.assertEquals("", FieldValidator.getInvalidityInfoForNewStartTime(earliestSessionStart, Const.DEFAULT_TIME_ZONE));

        Instant latestSessionStart = TimeHelperExtension
                .getInstantDaysOffsetFromNow(90)
                .truncatedTo(ChronoUnit.HOURS);
        Assertions.assertEquals("", FieldValidator.getInvalidityInfoForNewStartTime(latestSessionStart, Const.DEFAULT_TIME_ZONE));
    }
    ...
    public void testGetInvalidityInfoForNewStartTime_invalid_returnErrorString() {
        Instant threeHoursBeforeNowRounded = TimeHelperExtension
                ...
                .truncatedTo(ChronoUnit.HOURS);
        Assertions.assertEquals("The start time for this feedback session cannot be earlier than 2 hours before now.",
        ...
        Instant thirteenMonthsFromNow = TimeHelperExtension
                ...
                .truncatedTo(ChronoUnit.HOURS);
        Assertions.assertEquals("The start time for this feedback session cannot be later than 12 months from now.",
        ...
        Assertions.assertEquals("The start time for this feedback session must be at exact hour mark.",
    ...
    public void testGetInvalidityInfoForNewEndTime_valid_returnEmptyString() {
        Instant earliestSessionEnd = TimeHelperExtension
                ...
                .truncatedTo(ChronoUnit.HOURS);
        Assertions.assertEquals("", FieldValidator.getInvalidityInfoForNewEndTime(earliestSessionEnd, Const.DEFAULT_TIME_ZONE));

        Instant latestSessionEnd = TimeHelperExtension
                .getInstantDaysOffsetFromNow(180)
                .truncatedTo(ChronoUnit.HOURS);
        Assertions.assertEquals("", FieldValidator.getInvalidityInfoForNewEndTime(latestSessionEnd, Const.DEFAULT_TIME_ZONE));
    }
    ...
    public void testGetInvalidityInfoForNewEndTime_invalid_returnErrorString() {
        Instant twoHoursBeforeNowRounded = TimeHelperExtension
                ...
                .truncatedTo(ChronoUnit.HOURS);
        Assertions.assertEquals("The end time for this feedback session cannot be earlier than 1 hour before now.",
                FieldValidator.getInvalidityInfoForNewEndTime(twoHoursBeforeNowRounded, Const.DEFAULT_TIME_ZONE));

        Instant thirteenMonthsFromNow = TimeHelperExtension
                .getInstantMonthsOffsetFromNow(13, Const.DEFAULT_TIME_ZONE)
                .truncatedTo(ChronoUnit.HOURS);
        Assertions.assertEquals("The end time for this feedback session cannot be later than 12 months from now.",
        ...
        Instant notAtHourMark = TimeHelperExtension
                ...
                .truncatedTo(ChronoUnit.HOURS)
                .plus(Duration.ofMinutes(30));
        Assertions.assertEquals("The end time for this feedback session must be at exact hour mark.",
    ...
    public void testGetInvalidityInfoForTimeForSessionStartAndEnd_valid_returnEmptyString() {
        ...
        Assertions.assertEquals("", FieldValidator.getInvalidityInfoForTimeForSessionStartAndEnd(sessionStart, sessionEnd));
    }
    ...
    public void testGetInvalidityInfoForTimeForSessionStartAndEnd_invalid_returnErrorString() {
        Instant sessionStart = TimeHelperExtension.getInstantHoursOffsetFromNow(1);
        Instant sessionEnd = TimeHelperExtension.getInstantHoursOffsetFromNow(-1);
        Assertions.assertEquals("The end time for this feedback session cannot be earlier than the start time.",
    ...
    public void testGetInvalidityInfoForTimeForVisibilityStartAndSessionStart_invalid_returnErrorString() {
        Instant visibilityStart = TimeHelperExtension.getInstantHoursOffsetFromNow(1);
        Instant sessionStart = TimeHelperExtension.getInstantHoursOffsetFromNow(-1);
        Assertions.assertEquals("The start time for this feedback session cannot be earlier than the time when the "
    ...
    public void testGetInvalidityInfoForTimeForNewVisibilityStart_valid_returnEmptyString() {
        ...
        Assertions.assertEquals("", FieldValidator.getInvalidityInfoForTimeForNewVisibilityStart(
                visibilityStart, sessionStart));
    }
    ...
    public void testGetInvalidityInfoForTimeForNewVisibilityStart_invalid_returnErrorString() {
        ...
        Assertions.assertEquals("The time when the session will be visible for this feedback session cannot be "
    ...
    public void testGetInvalidityInfoForTimeForVisibilityStartAndResultsPublish_invalid_returnErrorString() {
        Instant visibilityStart = TimeHelperExtension.getInstantHoursOffsetFromNow(1);
        Instant resultsPublish = TimeHelperExtension.getInstantHoursOffsetFromNow(-1);
        Assertions.assertEquals("The time when the results will be visible for this feedback session cannot be "
    ...
    public void testGetInvalidityInfoForTimeForSessionEndAndExtendedDeadlines_invalid_returnErrorString() {
        ...
        Map<String, Instant> extendedDeadlines = new HashMap<>();
        extendedDeadlines.put("participant@email.com", TimeHelperExtension.getInstantHoursOffsetFromNow(-1));
        Assertions.assertEquals("The extended deadlines for this feedback session cannot be earlier than or at the same time as "
                        + "the end time.",
                FieldValidator.getInvalidityInfoForTimeForSessionEndAndExtendedDeadlines(
                        sessionEnd, extendedDeadlines));
    ...
    public void testGetInvalidityInfoForTimeForNotificationStartAndEnd_inValid_returnErrorString() {
        ...
        Assertions.assertEquals("The time when the notification will expire for this notification cannot be earlier "
    ...
    public void testGetInvalidityInfoForNotificationTitle_valid_returnEmptyString() {
        Assertions.assertEquals("", FieldValidator.getInvalidityInfoForNotificationTitle("valid title"));
    }

    @Test
    public void testGetInvalidityInfoForNotificationTitle_inValid_returnErrorString() {
        ______TS("Empty notification title");
        Assertions.assertEquals("The field 'notification title' is empty.",
        ...
        Assertions.assertEquals("\"" + invalidNotificationTitle + "\" is not acceptable to TEAMMATES as a/an "
    ...
    public void testGetInvalidityInfoForNotificationBody_valid_returnEmptyString() {
        Assertions.assertEquals("", FieldValidator.getInvalidityInfoForNotificationBody("valid body"));
    }

    @Test
    public void testGetInvalidityInfoForNotificationBody_inValid_returnErrorString() {
        Assertions.assertEquals("The field 'notification message' is empty.",
    ...
    public void testGetInvalidityInfoForNotificationStyle_valid_returnEmptyString() {
        Assertions.assertEquals("", FieldValidator.getInvalidityInfoForNotificationStyle("SUCCESS"));
    }

    @Test
    public void testGetInvalidityInfoForNotificationStyle_inValid_returnErrorString() {
        String invalidStyle = "invalid style";
        Assertions.assertEquals("\"" + invalidStyle + "\" is not an accepted notification style to TEAMMATES. ",
    ...
    public void testGetInvalidityInfoForNotificationTargetUser_valid_returnEmptyString() {
        Assertions.assertEquals("", FieldValidator.getInvalidityInfoForNotificationTargetUser("GENERAL"));
    }

    @Test
    public void testGetInvalidityInfoForNotificationTargetUser_inValid_returnErrorString() {
        String invalidUser = "invalid user";
        Assertions.assertEquals("\"" + invalidUser + "\" is not an accepted notification target user to TEAMMATES. ",
    ...
    public void testRegexName() {
        ...
        Assertions.assertTrue(StringHelper.isMatching(name, FieldValidator.REGEX_NAME));
        ...
        Assertions.assertFalse(StringHelper.isMatching(name, FieldValidator.REGEX_NAME));
    ...
    public void testRegexEmail() {
        ...
        Assertions.assertTrue(StringHelper.isMatching(email, FieldValidator.REGEX_EMAIL));

        ______TS("failure: no top level domain");
        email = "a@e";
        Assertions.assertFalse(StringHelper.isMatching(email, FieldValidator.REGEX_EMAIL));
    ...
    public void testRegexCourseId() {
        ...
        Assertions.assertTrue(StringHelper.isMatching(courseId, FieldValidator.REGEX_COURSE_ID));
        ...
        courseId = "CS101+B";
        Assertions.assertFalse(StringHelper.isMatching(courseId, FieldValidator.REGEX_COURSE_ID));
    }
    ...
    public void testRegexGoogleIdNonEmail() {
        ...
        Assertions.assertTrue(StringHelper.isMatching(googleId, FieldValidator.REGEX_GOOGLE_ID_NON_EMAIL));
        ...
        Assertions.assertFalse(StringHelper.isMatching(googleId, FieldValidator.REGEX_GOOGLE_ID_NON_EMAIL));
