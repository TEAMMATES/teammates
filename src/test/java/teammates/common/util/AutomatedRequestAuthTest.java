...
public class AutomatedRequestAuthTest extends BaseTestCase {
    ...
    public void testIsCronRequestPath_noContextPath() {
        ...
        Assertions.assertTrue(AutomatedRequestAuth.isCronRequestPath(req));
        ...
        Assertions.assertFalse(AutomatedRequestAuth.isCronRequestPath(req));
    }
    ...
    public void testIsWorkerRequestPath_noContextPath() {
        ...
        Assertions.assertTrue(AutomatedRequestAuth.isWorkerRequestPath(req));
        ...
        Assertions.assertFalse(AutomatedRequestAuth.isWorkerRequestPath(req));
    }
    ...
    public void testIsTrustedCronOrWorkerRequest_correctToken_cronPath() {
        ...
        Assertions.assertTrue(AutomatedRequestAuth.isTrustedCronOrWorkerRequest(req, TEST_CRON_WORKER_SECRET));
    }
    ...
    public void testIsTrustedCronOrWorkerRequest_bearerSchemeCaseInsensitive() {
        ...
        Assertions.assertTrue(AutomatedRequestAuth.isTrustedCronOrWorkerRequest(lower, TEST_CRON_WORKER_SECRET));
        Assertions.assertTrue(AutomatedRequestAuth.isTrustedCronOrWorkerRequest(upper, TEST_CRON_WORKER_SECRET));
    }
    ...
    public void testIsTrustedCronOrWorkerRequest_wrongToken() {
        ...
        Assertions.assertFalse(AutomatedRequestAuth.isTrustedCronOrWorkerRequest(req, TEST_CRON_WORKER_SECRET));
    }
    ...
    public void testIsTrustedCronOrWorkerRequest_bearerTokenTrimmingAccepted() {
        ...
        Assertions.assertTrue(AutomatedRequestAuth.isTrustedCronOrWorkerRequest(cronReq, TEST_CRON_WORKER_SECRET));
        Assertions.assertTrue(AutomatedRequestAuth.isTrustedCronOrWorkerRequest(workerReq, TEST_CRON_WORKER_SECRET));
    }

    @Test
    public void testIsCronAndWorkerSecretWellFormed_rejectsSurroundingWhitespace() {
        Assertions.assertFalse(AutomatedRequestAuth.isCronAndWorkerSecretWellFormed("  " + TEST_CRON_WORKER_SECRET + "  "));
        Assertions.assertTrue(AutomatedRequestAuth.isCronAndWorkerSecretWellFormed(TEST_CRON_WORKER_SECRET));
    }
    ...
    public void testTrustedCronVsWorkerPath_separation() {
        ...
        Assertions.assertTrue(AutomatedRequestAuth.isTrustedCronOrWorkerRequest(cronReq, TEST_CRON_WORKER_SECRET));
        Assertions.assertFalse(AutomatedRequestAuth.isWorkerRequestPath(cronReq));

        HttpServletRequest workerReq = mockTrustedRootContextRequest("/worker/run", "Bearer " + TEST_CRON_WORKER_SECRET);
        Assertions.assertTrue(AutomatedRequestAuth.isTrustedCronOrWorkerRequest(workerReq, TEST_CRON_WORKER_SECRET));
        Assertions.assertTrue(AutomatedRequestAuth.isWorkerRequestPath(workerReq));
    }
