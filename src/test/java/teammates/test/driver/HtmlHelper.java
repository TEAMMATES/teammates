...
public final class HtmlHelper {
    ...
    private static final String REGEX_HEXADECIMAL_CHAR_32 = "[A-F0-9]{32,}";

    private static final String REGEX_CONTINUE_URL = ".*?";
    private static final String REGEX_ENCRYPTED_STUDENT_EMAIL = REGEX_HEXADECIMAL_CHAR_32;
    private static final String REGEX_ENCRYPTED_COURSE_ID = REGEX_HEXADECIMAL_CHAR_32;
    private static final String REGEX_ENCRYPTED_REGKEY = REGEX_HEXADECIMAL_CHAR_32;
    ...
    private static final String REGEX_SESSION_TOKEN = REGEX_HEXADECIMAL_CHAR_32;
