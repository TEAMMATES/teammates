...
public final class HtmlHelper {
    ...
    private static String replaceUnpredictableValuesWithPlaceholders(String content) {
        ...
        String dateTimeNowMinusOneDay = sdf.format(nowMinusOneDay);
        String dateTimeNowPlusOneDay = sdf.format(nowPlusOneDay);
        ...
        return content // dev server admin absolute URLs (${teammates.url}/_ah/...)
                      ...
                      .replaceAll("(" + dateTimeNow + "|" + dateTimeNowMinusOneDay + "|" + dateTimeNowPlusOneDay + ")"
                              + REGEX_DISPLAY_TIME, "\\${datetime\\.now}")
