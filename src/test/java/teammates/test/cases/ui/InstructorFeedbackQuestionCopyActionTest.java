...
public class InstructorFeedbackQuestionCopyActionTest extends BaseActionTest {
    ...
    public void testExecuteAndPostProcess() throws Exception{
        ...
        FeedbackQuestionAttributes question1 = FeedbackQuestionsLogic.inst().getFeedbackQuestion(session1.feedbackSessionName, session1.courseId, 1);
        FeedbackQuestionAttributes question2 = FeedbackQuestionsLogic.inst().getFeedbackQuestion(session1.feedbackSessionName, session1.courseId, 2);
        ...
        assertEquals(
                Const.ActionURIs.INSTRUCTOR_FEEDBACK_EDIT_PAGE
                        ...
                        + "&fsname=Second+feedback+session"
                        + "&user="
        ...
        String expectedLogMessage =
                ...
                + "Feedback Session:<span class=\"bold\">(Second feedback session)</span> for Course <span class=\"bold\">"
                + "[idOfTypicalCourse1]</span> created.<br><span class=\"bold\">Essay question:</span> Rate 1 other student's "
        ...
        FeedbackQuestionAttributes question3 = FeedbackQuestionsLogic.inst().getFeedbackQuestion(session1.feedbackSessionName, session1.courseId, 3);
