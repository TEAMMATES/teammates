...
//        no links to check
    ...
    public void testInputValidation() {
        ...
        editPage.submitUnsuccessfully(null, "", null, null)
                .verifyStatus(FieldValidatorTest.getInterpolatedErrorMessage(
                                  FieldValidator.SIZE_CAPPED_NON_EMPTY_STRING_ERROR_MESSAGE,
                                  "", teamNameFieldName, FieldValidator.REASON_EMPTY,
        ...
        editPage.submitUnsuccessfully("", newTeamName, null, null)
                .verifyStatus(FieldValidatorTest.getInterpolatedErrorMessage(
                                  FieldValidator.SIZE_CAPPED_NON_EMPTY_STRING_ERROR_MESSAGE,
                                  "", personNameFieldName, FieldValidator.REASON_EMPTY,
        ...
        editPage.submitUnsuccessfully(invalidStudentName, null, null, null)
                .verifyStatus(FieldValidatorTest.getInterpolatedErrorMessage(
                                  FieldValidator.SIZE_CAPPED_NON_EMPTY_STRING_ERROR_MESSAGE,
                                  invalidStudentName, personNameFieldName,
                                  FieldValidator.REASON_TOO_LONG, FieldValidator.PERSON_NAME_MAX_LENGTH));
