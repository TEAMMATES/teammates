...
public class InstructorEditStudentFeedbackSaveActionTest extends BaseActionTest {
    ...
    public void testExecuteAndPostProcess() throws Exception{
        ...
        String moderatedStudentEmail = "student1InCourse1@gmail.tmt";
        ...
        assertEquals("/page/instructorEditStudentFeedbackPage" + 
                     "?error=false&moderatedstudent=student1InCourse1%40gmail.tmt" + 
                     "&user=idOfInstructor1OfCourse1&courseid=idOfTypicalCourse1" + 
        ...
        assertEquals("/page/instructorEditStudentFeedbackPage" + 
                     "?error=true&moderatedstudent=student1InCourse1%40gmail.tmt" + 
                     "&user=idOfInstructor1OfCourse1&courseid=idOfTypicalCourse1" + 
                     "&fsname=First+feedback+session",
                     r.getDestinationWithParams());
