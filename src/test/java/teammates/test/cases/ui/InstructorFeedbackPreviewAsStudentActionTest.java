...
public class InstructorFeedbackPreviewAsStudentActionTest extends BaseActionTest {
    ...
    public void testExecuteAndPostProcess() throws Exception {
        ...
        AssertHelper.assertLogMessageEquals("TEAMMATESLOG|||instructorFeedbackPreviewAsStudent|||instructorFeedbackPreviewAsStudent" +
    ...
    private InstructorFeedbackPreviewAsStudentAction getAction(final String... params) throws Exception {
