...
public class AdminInstructorAccountAddActionTest extends BaseActionTest {
    ...
    private void testGenerateNextDemoCourseIdForLengthLimit(int maximumIdLength) throws Exception {
        ...
        assertEquals("Case email input: normal short email with maximumIdLength:" + maximumIdLength, strWayShorterThanMaximum + normalIdSuffix, (String) generateNextDemoCourseId.invoke(a, strWayShorterThanMaximum + atEmail, maximumIdLength));
        ...
        assertEquals("Case courseId input: no index with maximumIdLength:" + maximumIdLength, strWayShorterThanMaximum + normalIdSuffix + "0", (String) generateNextDemoCourseId.invoke(a, strWayShorterThanMaximum + normalIdSuffix, maximumIdLength));
        assertEquals("Case courseId input: index is '0' with maximumIdLength:" + maximumIdLength, strWayShorterThanMaximum + normalIdSuffix + "1", (String) generateNextDemoCourseId.invoke(a, strWayShorterThanMaximum + normalIdSuffix + "0", maximumIdLength));
        assertEquals("Case courseId input: index is '9', short ID with maximumIdLength:" + maximumIdLength, strWayShorterThanMaximum + normalIdSuffix + "10", (String) generateNextDemoCourseId.invoke(a, strWayShorterThanMaximum + normalIdSuffix + "9", maximumIdLength));
