...
public class AllActionsAccessControlTest extends BaseActionTest {
    ...
    @Test
    public void InstructorFeedbackResultsAjaxByGqr() throws Exception {
    ...
    @Test
    public void InstructorFeedbackResultsAjaxByRgq() throws Exception {
    ...
    @Test
    public void InstructorFeedbackResultsAjaxByRqg() throws Exception {
