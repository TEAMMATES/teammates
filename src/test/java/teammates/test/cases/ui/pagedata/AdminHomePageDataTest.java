...
public class AdminHomePageDataTest extends BaseTestCase {
    ...
    private void setHomePageAttributes() {
        pageData.instructorDetails = "Instructor1 \t instructor1@email.tmt \t Teammates";
    ...
    private void testHomePageAttributes() {
        ...
        assertEquals("Instructor1 \t instructor1@email.tmt \t Teammates", pageData.instructorDetails);
    }
}
