...
public class InstructorCourseStudentListDownloadActionTest extends BaseActionTest {
    ...
    public void testExecuteAndPostProcess() throws Exception{
        ...
        assertEquals("Team,Student Name,Status,Email", fileContentLines[4]);
        assertEquals("\"Team 1.1\",\"student1 In Course1\",\"Joined\",\"student1InCourse1@gmail.com\"", fileContentLines[5]);
        assertEquals("\"Team 1.1\",\"student2 In Course1\",\"Joined\",\"student2InCourse1@gmail.com\"", fileContentLines[6]);
        assertEquals("\"Team 1.1\",\"student3 In Course1\",\"Joined\",\"student3InCourse1@gmail.com\"", fileContentLines[7]);
        assertEquals("\"Team 1.1\",\"student4 In Course1\",\"Joined\",\"student4InCourse1@gmail.com\"", fileContentLines[8]);
        assertEquals("\"Team 1.2\",\"student5 In Course1\",\"Joined\",\"student5InCourse1@gmail.com\"", fileContentLines[9]);
