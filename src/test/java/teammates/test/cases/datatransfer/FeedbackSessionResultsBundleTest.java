...
public class FeedbackSessionResultsBundleTest extends BaseLogicTest {
    ...
    public void testGetAllResponses() throws EntityDoesNotExistException {
        ...
        FeedbackSessionAttributes session =
                responseBundle.feedbackSessions.get("contribSession");
        ...
        FeedbackQuestionAttributes questionToGet = fqLogic.getFeedbackQuestion(fqa.feedbackSessionName, fqa.courseId, fqa.questionNumber);
        List<FeedbackResponseAttributes> allResponses =
                results.getActualResponses(questionToGet);
        ...
        for (int i =1; i<=4; i++) {
            ...
            allExpectedResponses.add(frLogic.getFeedbackResponse(questionToGet.getId(), fra.giver, fra.recipient).toString());
