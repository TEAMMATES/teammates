...
public class FeedbackResponseCommentSearchTest extends BaseSearchTest {
    ...
    public void allTests() {
        ...
        // fdbrI1S1=dataBundle.feedbackResponseComments.get("comment1FromT1C1ToR1Q1S1C1");
        ...
        // AssertHelper.assertSameContentIgnoreOrder(Arrays.asList(fdbrI1S1,fdbrI1S1Q2),
        // new ArrayList<>(bundle.comments.values()));
        ...
        assertEquals(2, bundle.numberOfResults);
        // AssertHelper.assertSameContentIgnoreOrder(Arrays.asList(fdbrI1S1Q2),
        // new ArrayList<>(bundle.comments.values()));
