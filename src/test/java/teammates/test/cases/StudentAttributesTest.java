...
public class StudentAttributesTest extends BaseTestCase {
	...
	public void testValidate() {
		...
		String errorMessage = 
				...
				+"\""+s.comments+"\" is not acceptable to TEAMMATES as comments about a student enrolled in a course because it is too long. The value of comments about a student enrolled in a course should be no longer than 500 characters. It should not be empty."+EOL
