...
public class BaseComponentTestCase extends BaseTestCase {
    ...
    protected static void verifyAbsentInDatastore(final AccountAttributes account) {
        assertNull(accountsDb.getAccount(account.googleId));
    }

    protected static void verifyPresentInDatastore(final AccountAttributes expectedAccount) {
    ...
    protected static void verifyAbsentInDatastore(final CommentAttributes comment) {
        assertNull(commentsDb.getComment(comment));
    }
    
    protected static void verifyPresentInDatastore(final CommentAttributes expected) {
    ...
    protected static void verifyAbsentInDatastore(final CourseAttributes course) {
        assertNull(coursesDb.getCourse(course.id));
    }

    protected static void verifyPresentInDatastore(final CourseAttributes expected) {
    ...
    protected static void verifyAbsentInDatastore(final FeedbackQuestionAttributes fq) {
        assertNull(fqDb.getFeedbackQuestion(fq.feedbackSessionName, fq.courseId, fq.questionNumber));    
    }
    
    protected static void verifyPresentInDatastore(final FeedbackQuestionAttributes expected) {
        verifyPresentInDatastore(expected, false);
    }
    
    protected static void verifyPresentInDatastore(final FeedbackQuestionAttributes expected, final boolean wildcardId) {
    ...
    protected static void verifyAbsentInDatastore(final FeedbackResponseCommentAttributes frc) {
        assertNull(frcDb.getFeedbackResponseComment(frc.feedbackResponseId, frc.giverEmail, frc.createdAt));
    }
    
    protected static void verifyPresentInDatastore(final FeedbackResponseCommentAttributes expected) {
    ...
    protected static void verifyAbsentInDatastore(final FeedbackResponseAttributes fr) {
        assertNull(frDb.getFeedbackResponse(fr.feedbackQuestionId, fr.giverEmail, fr.recipientEmail));
    }
    
    protected static void verifyPresentInDatastore(final FeedbackResponseAttributes expected) {
        verifyPresentInDatastore(expected, false);
    }
    
    protected static void verifyPresentInDatastore(final FeedbackResponseAttributes expected, final boolean wildcardId) {
    ...
    protected static void verifyAbsentInDatastore(final FeedbackSessionAttributes fs) {
        assertNull(fsDb.getFeedbackSession(fs.courseId, fs.feedbackSessionName));    
    }
    
    protected static void verifyPresentInDatastore(final FeedbackSessionAttributes expected) {
    ...
    protected static void verifyAbsentInDatastore(final InstructorAttributes instructor) {
        assertNull(instructorsDb.getInstructorForGoogleId(instructor.courseId, instructor.googleId));
    }

    protected static void verifyPresentInDatastore(final InstructorAttributes expected) {
    ...
    private static void equalizeIrrelevantData(final InstructorAttributes expectedInstructor,
                                               final InstructorAttributes actualInstructor) {
    ...
    protected static void verifyAbsentInDatastore(final StudentAttributes student) {
        assertNull(studentsDb.getStudentForEmail(student.course, student.email));
    }
    
    protected static void verifyPresentInDatastore(final StudentAttributes expected) {
    ...
    private static void equalizeIrrelevantData(
            final StudentAttributes expectedStudent,
            final StudentAttributes actualStudent) {
