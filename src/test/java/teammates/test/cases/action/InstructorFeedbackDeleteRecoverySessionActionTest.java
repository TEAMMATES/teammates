...
/**
 * SUT: {@link InstructorFeedbackDeleteRecoverySessionAction}.
 */
public class InstructorFeedbackDeleteRecoverySessionActionTest extends BaseActionTest {

    @Override
    protected String getActionUri() {
        return Const.ActionURIs.INSTRUCTOR_FEEDBACK_RECOVERY_SESSION_DELETE;
    }
    ...
    @Override
    protected InstructorFeedbackDeleteRecoverySessionAction getAction(String... params) {
        return (InstructorFeedbackDeleteRecoverySessionAction) gaeSimulation.getActionObject(getActionUri(), params);
    }
