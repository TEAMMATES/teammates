...
public class InstructorCourseDeleteRecoveryCourseActionTest extends BaseActionTest {
    ...
    public void testExecuteAndPostProcess() throws Exception {
        ...
        InstructorCourseDeleteRecoveryCourseAction deleteAction = getAction(submissionParams);
        ...
        assertEquals("The course idOfTypicalCourse3 has been permanently deleted.",
