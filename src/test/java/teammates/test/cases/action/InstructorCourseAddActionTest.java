...
public class InstructorCourseAddActionTest extends BaseActionTest {
    ...
    public void testExecuteAndPostProcess() throws Exception {
        ...
        pageData = (InstructorCoursesPageData) redirectResult.data;
        ...
        String expectedDestination = Const.ActionURIs.INSTRUCTOR_COURSES_PAGE + "?error=false&user=idOfInstructor1OfCourse1";
