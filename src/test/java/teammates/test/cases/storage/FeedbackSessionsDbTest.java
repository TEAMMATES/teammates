...
public class FeedbackSessionsDbTest extends BaseComponentTestCase {
    ...
    private FeedbackSessionAttributes getNewFeedbackSession() {
        return FeedbackSessionAttributes.builder("fsTest1", "testCourse", "valid@email.com")
                ...
                .withStartTime(Instant.now().plusMillis(1))
                .withEndTime(Instant.now().plusMillis(2))
                .withSessionVisibleFromTime(Instant.now().plusMillis(3))
                .withResultsVisibleFromTime(Instant.now().plusMillis(4))
