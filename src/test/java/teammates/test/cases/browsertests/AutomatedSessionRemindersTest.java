...
public class AutomatedSessionRemindersTest extends BaseUiTestCase {
    ...
    protected void prepareTestData() {
        ...
        closingFeedbackSession.setEndTimeUtc(TimeHelper.getDateOffsetToCurrentTime(1));
        ...
        closedFeedbackSession.setEndTimeUtc(TimeHelper.getMsOffsetToCurrentTime(-1000 * 60 * 30));
        ...
        openingFeedbackSession.setStartTimeUtc(TimeHelper.getDateOffsetToCurrentTime(-1));
