...
/**
 * SUT: {@link Const.CronJob#AUTOMATED_FEEDBACK_OPENING_REMINDERS},
 *      {@link Const.CronJob#AUTOMATED_FEEDBACK_CLOSING_REMINDERS},
 *      {@link Const.CronJob#AUTOMATED_FEEDBACK_CLOSED_REMINDERS},
 *      {@link Const.CronJob#AUTOMATED_FEEDBACK_PUBLISHED_REMINDERS}.
 */
@Priority(5)
public class AutomatedSessionRemindersTest extends BaseE2ETestCase {
    ...
    public void testFeedbackSessionOpeningReminders() {
        AppUrl openingRemindersUrl = createUrl(Const.CronJob.AUTOMATED_FEEDBACK_OPENING_REMINDERS);
        loginAdminToPage(openingRemindersUrl, GenericAppPage.class);
    }

    @Test
    public void testFeedbackSessionClosingReminders() {
        AppUrl closingRemindersUrl = createUrl(Const.CronJob.AUTOMATED_FEEDBACK_CLOSING_REMINDERS);
        loginAdminToPage(closingRemindersUrl, GenericAppPage.class);
    }

    @Test
    public void testFeedbackSessionClosedReminders() {
        AppUrl closedRemindersUrl = createUrl(Const.CronJob.AUTOMATED_FEEDBACK_CLOSED_REMINDERS);
        loginAdminToPage(closedRemindersUrl, GenericAppPage.class);
    }

    @Test
    public void testFeedbackSessionPublishedReminders() {
        AppUrl publishedRemindersUrl = createUrl(Const.CronJob.AUTOMATED_FEEDBACK_PUBLISHED_REMINDERS);
