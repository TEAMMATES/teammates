...
public class InstructorFeedbackEditPageUiTest extends BaseUiTestCase {
    ...
    private void testEditSessionAction() throws Exception {
        ...
        LocalDateTime overlapStartTime = TimeHelper.parseLocalDateTimeForSessionsForm("05/04/2015", "2", "0");
        LocalDateTime gapEndTime = TimeHelper.parseLocalDateTimeForSessionsForm("01/10/2017", "2", "0");
