...
public class InstructorFeedbackResultsPageUiTest extends BaseUiTestCase {
    ...
    private void testContent() throws Exception {
        ...
        resultsPage.clickAjaxLoadedPanelAndWaitForExpansion("panelHeading-1", "ajax_auto");
    ...
    public void testExceptionalCases() throws Exception {
        ...
        resultsPage.clickAjaxLoadedPanelAndWaitForExpansion("panelHeading-1", "ajax_auto");
        resultsPage.clickAjaxLoadedPanelAndWaitForExpansion("panelHeading-2", "ajax_auto");
        ...
        resultsPage.clickAjaxLoadedPanelAndWaitForExpansion("panelHeading-section-1-2", "ajax_auto");
    ...
    private void testModerateResponsesButton() {
        ...
        resultsPage.clickAjaxLoadedPanelAndWaitForExpansion("panelHeading-2", "ajax_auto");
        resultsPage.clickAjaxLoadedPanelAndWaitForExpansion("panelHeading-4", "ajax_auto");
    ...
    public void testViewPhotoAndAjaxForLargeScaledSession() throws Exception {
        ...
        resultsPage.clickAjaxLoadedPanelAndWaitForExpansion("panelHeading-1", "ajax_submit");
    ...
    private void testPanelsCollapseExpand() {
        ...
        resultsPage.clickGroupByTeam();
        resultsPage.displayByGiverRecipientQuestion();
        resultsPage.clickAjaxLoadedPanelAndWaitForExpansion("panelHeading-section-0-1", "ajax_auto");
