...
public class FeedbackSessionsLogicTest extends BaseLogicTest {
    ...
    private void testGetFeedbackSessionResultsSummaryAsCsv() throws Exception {
        ...
        expected = new String[] {
                ...
                "\"It's perfect\",1,50",
                "",
                "Team,Giver's Full Name,Giver's Last Name,Giver's Email,Recipient's Team,Recipient's Full Name,Recipient's Last Name,Recipient's Email,Feedback,Respondent Comments",
