...
public class FeedbackSessionsLogicTest extends BaseComponentUsingTaskQueueTestCase {
    ...
    public void testGetFeedbackSessionResultsSummaryAsCsv() throws Exception {
        ...
        */
        ...
        Summary Statistics,
        Recipient, Average, Minimum, Maximum, Average excluding student's own response
        ...
        */
        ...
        assertEquals(exportLines[5], "");
        assertEquals(exportLines[6], "Summary Statistics,");
        assertEquals(exportLines[7], "Recipient, Average, Minimum, Maximum, Average excluding student's own response");
        ...
        assertEquals(exportLines[17], "");
        assertEquals(exportLines[18], "Summary Statistics,");
        assertEquals(exportLines[19], "Recipient, Average, Minimum, Maximum, Average excluding student's own response");
        ...
        assertEquals(exportLines[25], "\"Instructors\",\"Instructor2 Course1\",\"Instructor2 Course1\",\"Instructors\",\"Instructor2 Course1\",\"Instructor2 Course1\",1");
