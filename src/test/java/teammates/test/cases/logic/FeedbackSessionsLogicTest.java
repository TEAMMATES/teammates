...
public class FeedbackSessionsLogicTest extends BaseComponentUsingTaskQueueTestCase {
    ...
    public void testGetFeedbackSessionResultsSummaryAsCsv() throws Exception {
        ...
        */
        ...
        assertEquals(exportLines[6], "Team,Giver (last name),Recipient's Team,Recipient (last name),Feedback");
        ...
        assertEquals(exportLines[13], "Team,Giver (last name),Recipient's Team,Recipient (last name),Feedback");
        ...
        assertEquals(exportLines[22], "Team,Giver (last name),Recipient's Team,Recipient (last name),Feedback");
        ...
        */
        ...
        assertEquals(exportLines[10], "");
        assertEquals(exportLines[11], "Team,Giver (last name),Recipient's Team,Recipient (last name),Feedback");
        ...
        assertEquals(exportLines[23], "Team,Giver (last name),Recipient's Team,Recipient (last name),Feedback");
        ...
        */
        ...
        assertEquals(exportLines[12], "Team,Giver (last name),Recipient's Team,Recipient (last name),Feedbacks:,\"It's good\",\"It's perfect\"");
        ...
        assertEquals(exportLines[25], "Team,Giver (last name),Recipient's Team,Recipient (last name),Feedbacks:,\"It's good\",\"It's perfect\"");
        ...
        */
        ...
        assertEquals(exportLines[9], "");
        assertEquals(exportLines[10], "Team,Giver (last name),Recipient's Team,Recipient (last name),Feedback");
        ...
        assertEquals(exportLines[21], "Team,Giver (last name),Recipient's Team,Recipient (last name),Feedback");
        ...
        */
        ...
        assertEquals(exportLines[10], "");
        assertEquals(exportLines[11], "");
        assertEquals(exportLines[12], "Team,Giver (last name),Recipient's Team,Recipient (last name),Feedbacks:,\"Grades\",\"Fun\"");
        ...
        assertEquals(exportLines[23], "");
        assertEquals(exportLines[24], "");
        assertEquals(exportLines[25], "Team,Giver (last name),Recipient's Team,Recipient (last name),Feedback");
        ...
        */
        ...
        assertEquals(exportLines[12], "");
        assertEquals(exportLines[13], "");
        assertEquals(exportLines[14], "Team,Giver (last name),Recipient's Team,Recipient (last name),Feedback");
