...
public class FeedbackResponsesLogicTest extends BaseLogicTest {
    ...
    private void testSpecialCharactersInTeamName() {
        ...
        assertEquals(4, frLogic.getViewableFeedbackResponsesForQuestionInSection(
                question,
        ...
        assertEquals(3, frLogic.getViewableFeedbackResponsesForQuestionInSection(
                question,
        ...
        assertEquals(1, frLogic.getViewableFeedbackResponsesForQuestionInSection(
                question,
    ...
    private void testUpdateFeedbackResponse() throws Exception {
        ...
        assertEquals(responseToUpdate.toString(), frLogic.getFeedbackResponse(responseToUpdate.feedbackQuestionId, responseToUpdate.giver,
        responseToUpdate.recipient).toString());
