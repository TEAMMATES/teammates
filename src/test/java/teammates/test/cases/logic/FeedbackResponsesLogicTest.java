...
public class FeedbackResponsesLogicTest extends BaseComponentTestCase {
    ...
    public void testUpdateFeedbackResponse() throws Exception {
        ...
        assertEquals(frLogic.getFeedbackResponse(
                responseToUpdate.feedbackQuestionId, responseToUpdate.giver, responseToUpdate.recipientEmail).toString(),
    ...
    public void testGetViewableResponsesForQuestionInSection() throws Exception {
        ...
        responses = frLogic.getViewableFeedbackResponsesForQuestionInSection(
                fq, instructor.email, UserType.Role.INSTRUCTOR, "Section 1");
        
        assertEquals(responses.size(), 3);
        
        responses = frLogic.getViewableFeedbackResponsesForQuestionInSection(
                fq, instructor.email, UserType.Role.INSTRUCTOR, "Section 2");
    ...
    private FeedbackResponseAttributes getResponseFromDatastore(DataBundle dataBundle, String jsonId) {
        ...
        return frLogic.getFeedbackResponse(
                qnId, response.giver, response.recipientEmail);
    }
