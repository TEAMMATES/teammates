...
public class FeedbackQuestionsLogicTest extends BaseComponentTestCase {
    ...
    public void testUpdateQuestionNumber() throws Exception {
        ...
        q5.questionNumber = 5;
        FeedbackQuestionAttributes q6 = getQuestionFromDatastore("qn6InSession1InCourse1");
        q6.questionNumber = 6;
        ...
        q5.questionNumber = 5;
        q6 = getQuestionFromDatastore("qn6InSession1InCourse1");
        q6.questionNumber = 6;
    ...
    public void testGetFeedbackQuestionsForStudents() {
        ...
        expectedQuestions.add(getQuestionFromDatastore("qn6InSession1InCourse1"));
        actualQuestions =
