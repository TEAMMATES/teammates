...
public class FeedbackSessionClosingRemindersActionTest extends BaseAutomatedActionTest {
    ...
    public void allTests() throws Exception {
        ...
        session1.setStartTimeUtc(TimeHelper.getDateOffsetToCurrentTime(-1));
        session1.setEndTimeUtc(TimeHelper.getDateOffsetToCurrentTime(1));
        ...
        session2.setStartTimeUtc(TimeHelper.getDateOffsetToCurrentTime(-1));
        session2.setEndTimeUtc(TimeHelper.getDateOffsetToCurrentTime(1));
        ...
        session3.setStartTimeUtc(TimeHelperExtension.getHoursOffsetToCurrentTime(1));
        session3.setEndTimeUtc(TimeHelper.getDateOffsetToCurrentTime(1));
