...
public class FeedbackSessionPublishedRemindersActionTest extends BaseAutomatedActionTest {
    ...
    public void allTests() throws Exception {
        ...
        session1.setResultsVisibleFromTimeUtc(TimeHelper.getDateOffsetToCurrentTime(-1));
        ...
        session2.setResultsVisibleFromTimeUtc(TimeHelper.getDateOffsetToCurrentTime(-1));
        ...
        session3.setResultsVisibleFromTimeUtc(Const.TIME_REPRESENTS_LATER);
