...
public class BackDoorLogicTest extends BaseTestCase{
	...
	public void testActivateReadyEvaluations() throws Exception{
		...
		EvaluationData evaluation2 = dataBundle.evaluations.get("evaluation1InCourse1OfCoord2");
		...
		evaluation2.startTime = Common.getMsOffsetToCurrentTimeInUserTimeZone(0, timeZone);
		...
		int course1StudentCount = backdoor.getStudentListForCourse(evaluation1.course).size();
		int course2StudentCount = backdoor.getStudentListForCourse(evaluation2.course).size();
