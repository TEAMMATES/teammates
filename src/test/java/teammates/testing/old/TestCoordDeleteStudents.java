...
public class TestCoordDeleteStudents extends BaseTest {
	...
	@Test
	public void CoordDeleteStudents() throws Exception {
		testDeleteUnregisteredStudent();
		testDeleteAllUnregisteredStudents();
		testDeleteRegisteredStudent();
		testDeleteAllRegisteredStudents();
	}
