...
QUnit.test('getMinDateForEndDate(startDate)', function(assert) {
    assert.deepEqual(getMinDateForEndDate(newDate('02 Apr 2012, 23:59')), newDate('02 Apr 2012, 23:59'),
                     'Return startDate input argument');
});

QUnit.test('getMaxDateForStartDate(endDate)', function(assert) {
    assert.deepEqual(getMaxDateForStartDate(newDate('02 Apr 2012, 23:59')), newDate('02 Apr 2012, 23:59'),
...
QUnit.test('getMaxDateForVisibleDate(startDate, publishDate)', function(assert) {
    assert.deepEqual(getMaxDateForVisibleDate(newDate('02 Apr 2012, 23:59'), null), newDate('02 Apr 2012, 23:59'),
                     'NULL value test');
    assert.deepEqual(getMaxDateForVisibleDate(newDate('02 Apr 2012, 23:59'), undefined), newDate('02 Apr 2012, 23:59'),
...
QUnit.test('getMinDateForPublishDate(visibleDate)', function(assert) {
    assert.deepEqual(getMinDateForPublishDate(newDate('02 Apr 2012, 23:59')), newDate('02 Apr 2012, 23:59'),
