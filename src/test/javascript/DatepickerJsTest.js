...
QUnit.test('getMinDateForEndDate(startDate)', function(assert) {
    assert.deepEqual(getMinDateForEndDate(newDate("02 Apr 2012, 23:59")), newDate("02 Apr 2012, 23:59"), 'Return date given as input argument');

QUnit.test('getMaxDateForStartDate(endDate)', function(assert) {
    assert.deepEqual(getMaxDateForStartDate(newDate("02 Apr 2012, 23:59")), newDate("02 Apr 2012, 23:59"), 'Return date given as input argument');
...
QUnit.test('getMinDateForPublishDate(visibleDate)', function(assert) {
    assert.deepEqual(getMinDateForPublishDate(newDate("02 Apr 2012, 23:59")), newDate("02 Apr 2012, 23:59"), 'Return date given as input argument');
