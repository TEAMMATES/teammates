...
<div class="well well-plain">
    ...
    <div>
        <button class="btn btn-primary addInstructorFormControl addInstructorsBtn" id="btnAddInstructorDetailsSingleLineForm" onclick="addInstructorFromFirstFormByAjax()">Add Instructor</button>
    </div>
</div>