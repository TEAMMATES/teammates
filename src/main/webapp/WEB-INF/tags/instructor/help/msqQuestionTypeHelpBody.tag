<%@ tag description="instructorHelpSessions and instructorFeedbackEdit - MSQ Question Body" pageEncoding="UTF-8" %>
...
<a href="#fbMcq" class="button_questionTypeHelpModal" data-modal-link = "questionTypeHelpModal_mcq">here</a> for details.
