...
<div id="editquestionwrapper-${fqForm.questionIndex}">
                    ...
                    <div class="col-sm-7">
                        <span>
                            ...
                            <select class="questionNumber nonDestructive text-primary"
                                ...
                                id="<%= Const.ParamsNames.FEEDBACK_QUESTION_NUMBER %>-${fqForm.questionIndex}" disabled>
                                <c:forEach items="${fqForm.questionNumberOptions}" var="option" varStatus="loop">
                                    <option ${option.attributesToString}${ loop.index + 1 == fqForm.questionIndex ? 'selected' : '' }>
                                        ${option.content}
                                    </option>
                                </c:forEach>
                            </select>
                ...
                <div class="col-sm-12 margin-bottom-15px background-color-light-blue">
                    ...
                    <div class="form-group" style="padding: 0 15px;">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="hidden" class="nonDestructive" name="<%= Const.ParamsNames.FEEDBACK_QUESTION_DESCRIPTION %>">
                        </div>
