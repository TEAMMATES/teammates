...
<table class="table-responsive table table-striped table-bordered">
    <thead>
        <tr>
            ...
            <th onclick="toggleSort(this,instructorHomeDateComparator);" class="button-sort-none">Start Date<span class="icon-sort unsorted"></span></th>
            <th onclick="toggleSort(this,instructorHomeDateComparator);" class="button-sort-none">End Date<span class="icon-sort unsorted"></span></th>
            <th>Status</th>
            <th>
