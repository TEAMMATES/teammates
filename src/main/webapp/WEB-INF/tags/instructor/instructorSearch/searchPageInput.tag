                ...
                <ul class="list-inline">
                    ...
                    <li>
                        <input id="comments-for-student-check" type="checkbox"
                               ...
                               <c:if test="${data.isSearchCommentForStudents}">checked</c:if>>
                    ...
                    <li>
                        <input id="comments-for-responses-check" type="checkbox"
                               ...
                               <c:if test="${data.isSearchCommentForResponses}">checked</c:if>>
                    ...
                    <li>
                        <input id="students-check" type="checkbox" 
                               ...
                               <c:if test="${data.isSearchForStudents || (!data.isSearchCommentForStudents 
                                             && !data.isSearchCommentForResponses)}">checked</c:if>>
