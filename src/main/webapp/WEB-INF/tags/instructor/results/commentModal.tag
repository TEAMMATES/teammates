    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <ul class="list-group" id="responseCommentTable-${responseRecipientIndex}-${responseGiverIndex}-${questionIndex}"
            style="${not empty responseRow.allCommentsOnResponse ? 'margin-top:15px;' : 'display:none'}">
          <c:forEach items="${responseRow.allCommentsOnResponse}" var="responseComment" varStatus="status">
