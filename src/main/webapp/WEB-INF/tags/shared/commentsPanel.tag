        ...
        <c:forEach items="${commentsForStudentsTables}"
            ...
            <div
                ...
                <ul class="list-group comments">
                    <c:forEach items="${commentsForStudentsTable.rows}"
                        var="commentRow">
                    ...
                    <c:if test="${forRecordsPage}">
                        <c:if
                            ...
                            <li class="list-group-item text-muted">
                                <i>You don't have any comments on
                                    this student.</i>
                            </li>
                        </c:if>
                            ...
                            <form method="post"
                                ...
                                <div class="form-group form-inline">
                                    <div class="form-group text-muted">
                                        <p>Comment about
                                            ${data.studentName}:</p>
                                        The default visibility for your
                                        comment is private. You may
                                        change it using the visibility
                                        options.
                                    </div>
                                    <a
