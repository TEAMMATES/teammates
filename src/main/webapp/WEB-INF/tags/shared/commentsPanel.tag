...
<div class="panel panel-primary" data-toggle="collapse" data-target="#panelBodyCollapse">
    <div class="panel-heading cursor-pointer" onclick="toggleChevron(this)">
    ...
    <div id="panelBodyCollapse" class="panel-collapse collapse in">
        <div class="panel-body">
            ...
            <c:forEach items="${commentsForStudentsTables}"
                var="commentsForStudentsTable">
                <div
                    class="panel panel-info student-record-comments${commentsForStudentsTable.extraClass}"
                    <c:if test="${empty commentsForStudentsTable.rows && not forRecordsPage}">style="display: none;"</c:if>>
                    <div class="panel-heading">
                        From <b>${commentsForStudentsTable.giverDetails}<c:if
                                test="${not empty courseId}"> (${courseId})</c:if></b>
                    ...
                    <ul class="list-group comments">
                        <c:forEach
                            items="${commentsForStudentsTable.rows}"
                            var="commentRow">
                            <c:set var="commentIndex"
                                value="${commentIndex + 1}" />
                            <shared:comment comment="${commentRow}"
                                commentIndex="${commentIndex}" />
                        </c:forEach>
                        <c:if test="${forRecordsPage}">
                            <c:if
                                test="${empty commentsForStudentsTable.rows}">
                                <li class="list-group-item text-muted">
                                    <i>You don't have any comments
                                        on this student.</i>
                                </li>
                            </c:if>
                            <c:set var="newCommentIndex"
                                value="${fn:length(commentsForStudentsTable.rows)}" />
                            <li
                                ...
                                <form method="post"
                                    ...
                                    <div class="form-group form-inline">
                                        <div
                                            ...
                                            your comment is private. You
                                            may change it using the
                                            visibility options.
                                        </div>
                                        <a
                                            id="visibility-options-trigger${newCommentIndex}"
                                    ...
                                    <div
                                        id="visibility-options${newCommentIndex}"
                                        ...
                                        <table class="table text-center"
                                            ...
                                            <tbody>
                                                ...
                                                <tr
                                                    id="recipient-person${newCommentIndex}">
                                                    <td
                                                        class="text-left">
                                                        <div
                                                            data-toggle="tooltip"
                                                ...
                                                <tr
                                                    id="recipient-team${newCommentIndex}">
                                                    <td
                                                        class="text-left">
                                                        <div
                                                            data-toggle="tooltip"
                                                ...
                                                <tr
                                                    id="recipient-section${newCommentIndex}">
                                                    <td
                                                        class="text-left">
                                                        <div
                                                            data-toggle="tooltip"
                                                ...
                                                <tr
                                                    id="recipient-course${newCommentIndex}">
                                                    <td
                                                        class="text-left">
                                                        <div
                                                            data-toggle="tooltip"
