<%@ tag description="feedbackSubmissionEdit.jsp - Displays feedback session details" pageEncoding="UTF-8" trimDirectiveWhitespaces="true" %>
    ...
    <div class="form-horizontal">
      <div class="panel-heading">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <p class="form-control-static" id="end-time" data-end-time="${feedbackSession.endTimeInIso8601Format}">${feedbackSession.endTimeString}</p>
          </div>
        </div>
