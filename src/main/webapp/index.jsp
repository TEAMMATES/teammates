    ...
    <div id="contentHolder">                  
        ...
        <div class="align-center">
            ...
            <table width="100%">
                <tr>
                    ...
                    <a href="request.jsp"><img src="images/requestButton.png" height="40px"/></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                </tr>
            </table>
        </div>
        ...
        <div class="overviewByte">
            ...
            <div class="overviewByteData">
                ...
                <p>TEAMMATES has been in operation since 2010. It has benefited from the work of over 
                 <a href="about.jsp">130 developers</a>. <br>TEAMMATES won the Grand Prize at the 
        ...
        <div class="overviewByte">
            ...
            <div class="overviewByteData">
                ...
                high degree of flexibility. <a href="features.jsp">More about our features...</a></p>
            </div>
            <div style="clear: both;"></div>
        </div>
        ...
        <div class="overviewByte">
            ...
            <div class="overviewByteData">
                ...
                <p>
                    ...
                    from the National University of Singapore. TEAMMATES also received funding support under the
                    <a href="https://www.google-melange.com/"> Google Summer of Code</a> program in 2014 and 2015.
                </p>
            </div>
            <div style="clear: both;"></div>
        </div>
