    ...
    <script>
        (function() {
            $(document).ready(function() {
				...
				$('#instructorStudentCommentEditPage').load('<%=Const.ActionURIs.INSTRUCTOR_STUDENT_COMMENT_EDIT%>?user=teammates.test&courseid=CS2104&studentemail=teammates.test%40gmail.tmt&commentid=comment-id&commentedittype=comment-edit-type #mainContent');
