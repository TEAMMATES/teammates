...
<t:helpPage>
    ...
    <div class="side-navigation-helper">
        <ul>
            <li><a href="#top">Help for Instructors</a></li>
            <li><a href="#gs">Getting Started</a></li>
            <li><a href="#faq">Frequently Asked Questions</a></li>
            <li><a href="#tips">Tips for conducting 'team peer evaluation' sessions</a></li>
            <li><a href="#editCourse">Add/Edit instructors</a></li>
            <li><a href="#sessionTypes">Sessions</a></li>
            <li><a href="#editComments">Comments</a></li>
        </ul>
    </div>
</t:helpPage>