...
<div id="contentHolder">
  <div class="panel-group">
    ...
    <div class="panel panel-primary" id="fbQuestionTypes">
      <div class="panel-heading">
        <h3 class="panel-title">
          <a data-toggle="collapse" href="#fbQuestionTypesBody">What types of questions can I add to a session?</a>
        </h3>
      </div>
      <div id="fbQuestionTypesBody" class="panel-collapse collapse">
        <div class="panel-body">
