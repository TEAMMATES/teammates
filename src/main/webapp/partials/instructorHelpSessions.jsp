            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  ...
                  <ul>
                    <li>
                      session using template: team peer evaluation (optimized) - this provides five standard questions, including a
                      contribution question that can be used to gauge team contributions. The template is optimized as contribution
                      questions are optimized to obtain a more accurate view of the contribution distribution (e.g. by omitting
                      self-ratings when calculating average contribution). However, as contribution questions can be harder to explain
                      to students, this template is recommended for users who are more familiar with TEAMMATES and ready to use a use
                      a more complex question type in their feedback sessions.
                    </li>
                    <li>
                      session using template: team peer evaluation - this provides five standard questions, including a distribution
                      question that can be used to gauge team contributions. While distribution questions are not as optimized as
                      contribution questions, they still work fairly well in obtaining a view of the contribution distribution. Hence,
                      this template is recommended for users who are newer to TEAMMATES and want to use a simpler questoin type in their
                      feedback sessions.
                    </li>
                  </ul>
                </li>
              ...
              <div class="well well-plain">
                <form class="form-group" name="form_feedbacksession" onsubmit="return false">
                  <div class="row" data-toggle="tooltip" data-placement="top" title="Select a different type of session here.">
                    ...
                    <div class="col-md-10">
                      <div class="col-xs-10 tablet-no-padding">
