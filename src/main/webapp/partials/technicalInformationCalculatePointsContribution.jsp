  ...
  <ul>
    <li>
      ...
      <div class="helpSectionContent">
        ...
        (see <a href="https://github.com/TEAMMATES/teammates/blob/master/docs/glossary.md"> glossary</a>).
        <br>
    ...
    <li>
      ...
      <div class="helpSectionContent">
        <ol type="1">
          ...
          <li>
            <span class="text-bold">Calculate peerContributionRatio values by removing self-rating bias</span>
            <div class="helpSectionContent">
          ...
          <li>
            <span class="text-bold">Calculate averagePerceivedContributionRatio</span>
            <div class="helpSectionContent">
              ...
              <ol type="i">
                <li>
                  <span class="text-bold">Calculate averagePerceived:</span>
                  <div class="helpSectionContent">
                ...
                <li>
                  <span class="text-bold">Calculate normalizedAveragePerceived:</span>
                  <div class="helpSectionContent">
          ...
          <li>
            <span class="text-bold">Denormalize normalizedAveragePerceived</span>
            <div class="helpSectionContent">
              For each student, denormalize normalizedAveragePerceived. We scale back to match the total of original
