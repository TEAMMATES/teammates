...
const ParamsNames = {
    ...
    FEEDBACK_QUESTION_CONSTSUMPOINTSMIN: 'constSumPointsMin',
    FEEDBACK_QUESTION_CONSTSUMPOINTSMAX: 'constSumPointsMax',
    FEEDBACK_QUESTION_CONSTSUMPOINTSMINMAX: 'constSumPointsMinMax',
