...
const ParamsNames = {
    ...
    FEEDBACK_SESSION_SESSIONVISIBILITY_CUSTOM: 'sessionVisibilityCustom',
    FEEDBACK_SESSION_SESSIONVISIBILITY_ATOPEN: 'sessionVisibilityAtOpen',
    FEEDBACK_SESSION_RESPONSESVISIBILITY: 'responsesVisibilityOptions',
    FEEDBACK_SESSION_RESPONSESVISIBILITY_CUSTOM: 'responsesVisibilityCustom',
    FEEDBACK_SESSION_RESPONSESVISIBILITY_IMMEDIATELY: 'responsesVisibilityImmediate',
    FEEDBACK_SESSION_RESPONSESVISIBILITY_LATER: 'responsesVisibilityLater',
    FEEDBACK_SESSION_SENDEMAILS: 'sendEmailsOptions',
    FEEDBACK_SESSION_SENDEMAILS_ATOPEN: 'sendEmailsAtOpen',
    FEEDBACK_SESSION_SENDEMAILS_ATCLOSED: 'sendEmailsAtClosed',
    FEEDBACK_SESSION_SENDEMAILS_ONPUBLISH: 'sendEmailsOnPublish',
