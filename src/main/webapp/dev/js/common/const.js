...
const ParamsNames = {
    ...
    FEEDBACK_QUESTION_MSQ_ENABLE_MAX_SELECTABLE_CHOICES: 'msqEnableMaxSelectableChoices',
    FEEDBACK_QUESTION_MSQ_ENABLE_MIN_SELECTABLE_CHOICES: 'msqEnableMinSelectableChoices',
