...
<t:staticPage currentPage="features">
    <div id="contentHolder">
        ...
        <div class="feature-details">
            <h2>Powerful visibility control</h2>
        ...
        <div class="feature-details">
            <h2>Fine-grain access control</h2>
        ...
        <div class="feature-details">
            <h2>Different question types</h2>
        ...
        <div class="feature-details">
            <h2>No signup required for students</h2>
