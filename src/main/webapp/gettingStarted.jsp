...
<div id="contentHolder">
  <p>
    Welcome to TEAMMATES! Follow the following steps to create your first feedback session and get familiar with how TEAMMATES works.
  </p>
  <h2>1. Set up a course</h2>
  <p>
  ...
  <h2>3. Wait for your session to open</h2>
  <p>
  ...
  <h2>4. View and publish session results</h2>
  <p>
  ...
  <h2>5. Learn about other actions you can perform</h2>
  <p>
