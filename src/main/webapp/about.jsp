...
<t:staticPage currentPage="about">
    ...
    <div class="container">
        <section class="row">
            ...
            <h2 class="margin_top_50px">Acknowledgements</h2>
            <h3>
            ...
            <ul class="no-bullets">
                <li>
                    <a href="http://www.comp.nus.edu.sg/" target="_blank" rel="noopener noreferrer">School of Computing,
                        National University of Singapore (NUS)</a>, for providing us with the infrastructure support to
                    run the project.
                </li>
                <li>
                    <a href="http://www.cdtl.nus.edu.sg/" target="_blank" rel="noopener noreferrer">Centre for
                        Development of Teaching and Learning (CDTL)</a> of NUS, for supporting us with several Teaching
                    Enhancement Grants over the years.
                </li>
                <li>
                    <b>Learning Innovation Fund-Technology (LIF-T)</b> initiative of NUS, for funding us for the
                    2015-2018 period.
                </li>
                <li>
                    <b>Google Summer of Code</b> Program, for including TEAMMATES as a mentor organization in GSoC2014,
                    GSoC2015 and GSoC2016 editions.
                </li>
                <li>
                    <b>Facebook Open Academy</b> Program, for including TEAMMATES as a mentor organization in FBOA 2016.
                </li>
                <li>
                    <b>YourKit LLC</b>, for providing us with free licenses for the <a
                        href="https://www.yourkit.com/java/profiler/" target="_blank" rel="noopener noreferrer">YourKit
                    Java Profiler</a>
        ...
        <section class="row">
            <h2 class="margin_top_50px">Core Team</h2>

            <div class="row">
                <div class="margin-top-7px col-xs-12 col-sm-5 col-md-4 col-lg-3">
                    <img class="img-responsive" src="images/teammembers/damith.png">
                    <a href="http://www.comp.nus.edu.sg/~damithch/" target="_blank" rel="noopener noreferrer">Damith C.
                        Rajapakse</a><br><br>
                    Founder (2010)<br>
                    Project Mentor (2010 -)
                </div>
        ...
        <hr>
        <section class="row">
            <h2 class="margin_top_50px">Past Team Members</h2>
            ...
            <div class="row">
                ...
                <div class="margin-top-7px col-xs-12 col-sm-5 col-md-3 col-lg-2">
                    <img src="images/teammembers/shawn.png" width="80px"><br>
                    Shawn Lee<br><br>
                    Area Lead<br>
                    Snr Developer
                </div>
                <div class="margin-top-7px col-xs-12 col-sm-5 col-md-3 col-lg-2">
                    <img src="images/teammembers/yangmo.png" width="80px"><br>
                    Yang Mo<br><br>
                    Area Lead<br>
                    Snr Developer
                </div>
                <div class="margin-top-7px col-xs-12 col-sm-5 col-md-3 col-lg-2">
                    <img src="images/teammembers/arnold.png" width="80px"><br>
                    Arnold Koroa<br><br>
                    Area Lead<br>
                    Snr Developer
                </div>
            ...
            <div class="row">
                <div class="margin-top-7px col-xs-12 col-sm-5 col-md-3 col-lg-2">
                    <img src="images/teammembers/ivan.png" width="80px"><br>
                    Ivan Poon<br><br>
                    Area Lea<br>
                    Snr Developer
                </div>
                <div class="margin-top-7px col-xs-12 col-sm-5 col-md-3 col-lg-2">
                    <img src="images/teammembers/jamesdjuhartono.png" width="80px"><br>
                    James Djuhartono<br><br>
                    Area Lead<br>
                    Snr Developer
                </div>
                <div class="margin-top-7px col-xs-12 col-sm-5 col-md-3 col-lg-2">
                    <img src="images/teammembers/ryan.png" width="80px"><br>
                    Ryan Chang <br><br>
                    Snr Developer
                </div>

                <div class="margin-top-7px col-xs-12 col-sm-5 col-md-3 col-lg-2">
                    <img src="images/teammembers/theongsiang.png" width="80px"><br>
                    Oo Theong Siang<br><br>
                    Area Lead<br>
                    Snr Developer
                </div>
                <div class="margin-top-7px col-xs-12 col-sm-5 col-md-3 col-lg-2">
                    <img src="images/teammembers/hunar.png" width="80px"><br>
                    Hunar Khanna<br><br>
                    Area Lead<br>
                    Snr Developer
                </div>
                <div class="margin-top-7px col-xs-12 col-sm-5 col-md-3 col-lg-2">
                    <img src="images/teammembers/qiaoliang.png" width="80px"><br>
                    Qiao Liang<br><br>
                    Area Lead<br>
                    Snr Developer
                </div>
            ...
            <div class="row">
                <div class="margin-top-7px col-xs-12 col-sm-5 col-md-3 col-lg-2">
                    <img src="images/teammembers/kenny.png" width="80px"><br>
                    Tan How Cheng Kenny<br><br>
                    Area Lead<br>
                    Snr Developer
                </div>
                <div class="margin-top-7px col-xs-12 col-sm-5 col-md-3 col-lg-2">
                    <img src="images/teammembers/chunteck.png" width="80px"><br>
                    Goh Chun Teck<br><br>
                    Project Lead<br>
                    Area Lead<br>
                    Snr Developer
                ...
                <div class="margin-top-7px col-xs-12 col-sm-5 col-md-3 col-lg-2">
                    <img src="images/teammembers/wangsha.png" width="80px"><br>
                    Wang Sha<br><br>
                    Project Lead<br>
                    Area Lead<br>
                    Snr Developer
                ...
                <div class="margin-top-7px col-xs-12 col-sm-5 col-md-3 col-lg-2">
                    <img src="images/teammembers/james.png" width="80px"><br>
                    Long Dam Tuan, James<br><br>
                    Project Lead<br>
                    Area Lead<br>
                    Snr Developer
                </div>
        ...
        <hr>
        <section class="row">
            <h2 class="margin_top_50px">Past Committers</h2>
    ...
    <hr>
    <section class="row">
        <h2 class="margin_top_50px">Contributors</h2>

        <div class="margin-top-7px col-xs-12 col-sm-6 col-md-6 col-lg-6">
