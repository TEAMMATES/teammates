...
<t:staticPage currentPage="about">
    <div class="container">
        ...
        <section class="row">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><strong><a class="about-us-header" data-toggle="collapse" href="#contributorsList">Contributors:<span class="pull-right glyphicon glyphicon-chevron-down"></span></a></strong></h3>
                </div>
                <div id="contributorsList" class="panel-body panel-collapse collapse">

                    <table class="ordered-table">
                        <tr class="skip"><th colspan="2"><h4>Multiple contributions</h4></th></tr>
                        <tr>
                            <td>Adam Jones</td>
                        ...
                        <tr class="skip"><th colspan="2"><h4>One-time contributions</h4></th></tr>
                        <tr>
                            <td>A Sai Krishna</td>
