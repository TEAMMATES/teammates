    ...
    <div id="mainContainer">
                ...
                <div id="menuHolder">
                    ...
                    <div id="loginHolder">
                        <form action="/login" style="float: left" name="studentLogin">
                            <input type="submit" name="student" class="button"
                                id="btnStudentLogin" value="Student Login">
                        </form>
                        <form action="/login" name="instructorLogin" style="float: left">
                            <input type="submit" name="instructor" class="button"
                                id="btnInstructorLogin" value=" Instructor Login">
                        </form>
                    </div>
        ...
        <p class="bold">Core Team:</p>
          ...
          <table>
            <tr>
              ...
              <td class="coreTeamDetailsCell">
                ...
                Committer (Aug 2015 - Sep 2015)<br>
                <br>
              </td>
            </tr>
            <tr>
          ...
          <p class="bold">Past Team Members:</p>
            <div style="margin: 0 auto; padding: 0 52px 15px;">
                <ol>
                <li><img src="images/teammembers/bui.png" width="80px"><br> 
                    Bui Trong Nhan<br>
                    Area Lead - Scalability (Aug 2014 - Dec 2015)<br>
                    Snr Developer (June 2014 - Jul 2014)<br>
                    Committer (Apr 2014 - May 2014)<br><br>
                </li>
                <li><img src="images/teammembers/kai.png" width="80px"><br> 
                    Xie Kai<br>
                    Area Lead - Comments (Aug 2014 - Dec 2015)<br>
                    Snr Developer (June 2014 - Jul 2014)<br>
                    Committer (Apr 2014 - May 2014)<br><br>
                </li>
                <li><img src="images/teammembers/junchao.png" width="80px"><br> 
                    Gu Junchao<br>
                    Area Lead - Access Control (Aug 2014 - Dec 2015)<br>
                    Snr Developer (June 2014 - Jul 2014)<br>
                    Committer (Apr 2014 - May 2014)<br><br>
                </li>
                <li><img src="images/teammembers/shawn.png" width="80px"> 
                    Shawn Lee (Area Lead, Snr Developer)</li>
                <li><img src="images/teammembers/yangmo.png" width="80px"> 
                    Yang Mo (Area Lead, Snr Developer)</li>
                <li><img src="images/teammembers/arnold.png" width="80px"> 
                    Arnold Koroa (Area Lead, Snr Developer)</li>
                <li><img src="images/teammembers/ivan.png" width="80px"> 
                    Ivan Poon (Area Lead, Snr Developer)</li>
                <li><img src="images/teammembers/jamesdjuhartono.png" width="80px"> 
                    James Djuhartono (Area Lead, Snr Developer)</li>
                <li><img src="images/teammembers/ryan.png" width="80px"> 
                    Ryan Chang (Snr Developer)</li>
                <li><img src="images/teammembers/theongsiang.png" width="80px"> 
                    Oo Theong Siang (Area Lead, Snr Developer)</li>
                <li><img src="images/teammembers/hunar.png" width="80px"> 
                    Hunar Khanna (Area Lead, Snr Developer)</li>
                <li><img src="images/teammembers/qiaoliang.png" width="80px"> 
                    Qiao Liang (Area Lead, Snr Developer)</li>
                <li><img src="images/teammembers/kenny.png" width="80px"> 
                    Tan How Cheng Kenny (Area Lead, Snr Developer)</li>
                <li><img src="images/teammembers/chunteck.png" width="80px"> 
                    Goh Chun Teck (Project Lead, Area Lead, Snr Developer)</li>
                <li><img src="images/teammembers/wangsha.png" width="80px"> 
                    Wang Sha (Project Lead, Area Lead, Snr Developer)</li>
                <li><img src="images/teammembers/james.png" width="80px"> 
