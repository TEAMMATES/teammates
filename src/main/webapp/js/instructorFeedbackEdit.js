...
function addRubricRow(questionNumber) {
    ...
    var rubricRowTemplate =
      ...
      +                 "<span class=\"glyphicon glyphicon-remove\"></span>"
      +             "</span>"
      +             "<textarea class=\"form-control\" rows=\"7\" id=\"${Const.ParamsNames.FEEDBACK_QUESTION_RUBRICSUBQUESTION}-${qnIndex}-${row}\" name=\"${Const.ParamsNames.FEEDBACK_QUESTION_RUBRICSUBQUESTION}-${row}\">${subQuestion}</textarea>"
      +         "</div>"
      +     "</td>"
    ...
    var rubricRowFragmentTemplate =
      ...
      +   "<textarea class=\"form-control\" rows=\"7\" id=\"${Const.ParamsNames.FEEDBACK_QUESTION_RUBRICDESCRIPTION}-${qnIndex}-${row}-${col}\" name=\"${Const.ParamsNames.FEEDBACK_QUESTION_RUBRICDESCRIPTION}-${row}-${col}\">${description}</textarea>"
      + "</td>";
