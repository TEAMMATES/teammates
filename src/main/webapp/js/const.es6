...
Const.InstructorCourse = {
    ...
    DISPLAY_COURSE_LONG_ID: `Course ID should not exceed ${Const.FieldLength.COURSE_ID_MAX_LENGTH} characters.`,
    DISPLAY_COURSE_LONG_NAME: `Course name should not exceed ${Const.FieldLength.COURSE_NAME_MAX_LENGTH} characters.`,
    DISPLAY_COURSE_INVALID_ID: 'Please use only alphabets, numbers, dots, hyphens, underscores and ' +
                               'dollar signs in course ID. Spaces are not allowed for course ID.',
...
Const.StatusType.isValidType = (type) => {
