...
<body onload="readyFeedbackPage(); initializetooltip();">
    ...
    <div id="frameBodyWrapper" class="container theme-showcase">
            ...
            <div class="well well-plain">
                <div class="row">
                    <h4 class="label-control col-md-2 text-md">Session Type</h4>
                    <div class="col-md-10">
                ...
                <br>
                <form class="form-group" method="post" action="<%=Const.ActionURIs.INSTRUCTOR_FEEDBACK_ADD%>" name="form_addfeedbacksession">
                    <div class="panel panel-primary">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="<%=Const.ParamsNames.COURSE_ID%>" class="col-sm-4 control-label" 
                                            title="<%=Const.Tooltips.FEEDBACK_SESSION_COURSE%>" data-toggle="tooltip" data-placement="top">Course</label>
                                        <div class="col-sm-8">
                                            <select class="form-control"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="<%=Const.ParamsNames.FEEDBACK_SESSION_TIMEZONE%>" class="col-sm-4 control-label" 
                                            title="<%=Const.Tooltips.EVALUATION_INPUT_TIMEZONE%>" data-toggle="tooltip" data-placement="top">Timezone</label>
                                        <div class="col-sm-8">
                                            <select class="form-control" 
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="<%=Const.ParamsNames.FEEDBACK_SESSION_NAME%>" class="col-sm-2 control-label" 
                                            title="<%=Const.Tooltips.FEEDBACK_SESSION_INPUT_NAME%>" data-toggle="tooltip" data-placement="top">Session name</label>
                                        <div class="col-sm-10">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="form-group">
                                            <label for="<%=Const.ParamsNames.FEEDBACK_SESSION_INSTRUCTIONS%>" class="col-sm-2 control-label" 
                                                title="<%=Const.Tooltips.FEEDBACK_SESSION_INSTRUCTIONS%>" data-toggle="tooltip" data-placement="top">Instructions</label>
                                            <div class="col-sm-10">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="<%=Const.ParamsNames.FEEDBACK_SESSION_STARTDATE%>" class="label-control"
                                                title="<%=Const.Tooltips.FEEDBACK_SESSION_STARTDATE%>" data-toggle="tooltip" data-placement="top">Submission opening time</label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                ...
                                <div class="col-md-5 border-left-gray">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="<%=Const.ParamsNames.FEEDBACK_SESSION_ENDDATE%>" class="label-control"
                                                title="<%=Const.Tooltips.FEEDBACK_SESSION_ENDDATE%>" data-toggle="tooltip" data-placement="top">Submission closing time</label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                ...
                                <div class="col-md-2 border-left-gray">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label for="<%=Const.ParamsNames.FEEDBACK_SESSION_GRACEPERIOD%>" class="control-label"
                                                title="<%=Const.Tooltips.EVALUATION_INPUT_GRACEPERIOD%>"  data-toggle="tooltip" data-placement="top">Grace period</label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-6" title="<%=Const.Tooltips.FEEDBACK_SESSION_SESSIONVISIBLELABEL%>" data-toggle="tooltip" data-placement="top">
                                    ...
                                    <div class="row radio">
                                        <div class="col-md-2" title="<%=Const.Tooltips.FEEDBACK_SESSION_VISIBLEDATE%>" data-toggle="tooltip" data-placement="top">
                                            <label for="<%=Const.ParamsNames.FEEDBACK_SESSION_SESSIONVISIBLEBUTTON%>_custom">At </label>
                                            <input type="radio"
                                    ...
                                    <div class="row radio">
                                        <div class="col-md-6" title="<%=Const.Tooltips.FEEDBACK_SESSION_SESSIONVISIBLEATOPEN%>" data-toggle="tooltip" data-placement="top">
                                            <label for="<%=Const.ParamsNames.FEEDBACK_SESSION_SESSIONVISIBLEBUTTON%>_atopen">Submission opening time </label>
                                            <input type="radio"
                                                name="<%=Const.ParamsNames.FEEDBACK_SESSION_SESSIONVISIBLEBUTTON%>"
                                    ...
                                    <div class="row radio">
                                        <div class="col-md-6" title="<%=Const.Tooltips.FEEDBACK_SESSION_SESSIONVISIBLENEVER%>" data-toggle="tooltip" data-placement="top">
                                            <label for="<%=Const.ParamsNames.FEEDBACK_SESSION_SESSIONVISIBLEBUTTON%>_never">Never (this is a private session)</label>
                                            <input type="radio" 
                                                name="<%=Const.ParamsNames.FEEDBACK_SESSION_SESSIONVISIBLEBUTTON%>"
                                ...
                                <div class="col-md-6 border-left-gray">
                                    <div class="row">
                                        <div class="col-md-6" title="<%=Const.Tooltips.FEEDBACK_SESSION_RESULTSVISIBLELABEL%>" data-toggle="tooltip" data-placement="top">
                                            <label class="label-control">Responses visible from</label>
                                        </div>
                                    </div>
                                    <div class="row radio">
                                        <div class="col-md-2" title="<%=Const.Tooltips.FEEDBACK_SESSION_RESULTSVISIBLECUSTOM%>" data-toggle="tooltip" data-placement="top">
                                            <label for="<%=Const.ParamsNames.FEEDBACK_SESSION_RESULTSVISIBLEBUTTON%>_custom">At</label>
                                        ...
                                        <div class="col-md-4">
                                            <select class="form-control" 
                                                ...
                                                <%if(data.newFeedbackSession==null || TimeHelper.isSpecialTime(data.newFeedbackSession.resultsVisibleFromTime))
                                                    out.print("disabled=\"disabled\"");%>>
                                                    <%
                                                        date = (data.newFeedbackSession == null || TimeHelper.isSpecialTime(data.newFeedbackSession.resultsVisibleFromTime)) 
                                                                ? null
                                    ...
                                    <div class="row radio">
                                        <div class="col-md-3" title="<%=Const.Tooltips.FEEDBACK_SESSION_RESULTSVISIBLEATVISIBLE%>" data-toggle="tooltip" data-placement="top">
                                            <label for="<%=Const.ParamsNames.FEEDBACK_SESSION_RESULTSVISIBLEBUTTON%>_atvisible">Immediately</label>
                                            <input type="radio" 
                                                name="<%=Const.ParamsNames.FEEDBACK_SESSION_RESULTSVISIBLEBUTTON%>"
                                    ...
                                    <div class="row radio">
                                        <div class="col-md-4" title="<%=Const.Tooltips.FEEDBACK_SESSION_RESULTSVISIBLELATER%>" data-toggle="tooltip" data-placement="top">
                                            <label for="<%=Const.ParamsNames.FEEDBACK_SESSION_RESULTSVISIBLEBUTTON%>_later">Publish manually</label>
                                            <input type="radio" 
                                    ...
                                    <div class="row radio">
                                        <div class="col-md-2" title="<%=Const.Tooltips.FEEDBACK_SESSION_RESULTSVISIBLENEVER%>" data-toggle="tooltip" data-placement="top">
                                            <label for="<%=Const.ParamsNames.FEEDBACK_SESSION_RESULTSVISIBLEBUTTON%>_never">Never</label>
                                            <input type="radio"
                                                name="<%=Const.ParamsNames.FEEDBACK_SESSION_RESULTSVISIBLEBUTTON%>"
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-sm-2" 
                                    title="<%=Const.Tooltips.FEEDBACK_SESSION_SENDJOINEMAIL%>" data-toggle="tooltip" data-placement="top">
                                    <div class="checkbox">
                                        <label for="<%=Const.ParamsNames.FEEDBACK_SESSION_SENDREMINDEREMAIL%>_join">Join reminder</label>
                                ...
                                <div class="col-sm-3" 
                                    title="<%=Const.Tooltips.FEEDBACK_SESSION_SENDOPENEMAIL%>" data-toggle="tooltip" data-placement="top">
                                    <div class="checkbox">
                                ...
                                <div class="col-sm-3" 
                                    title="<%=Const.Tooltips.FEEDBACK_SESSION_SENDCLOSINGEMAIL%>" data-toggle="tooltip" data-placement="top">
                                    <div class="checkbox">
                                        <label for="<%=Const.ParamsNames.FEEDBACK_SESSION_SENDREMINDEREMAIL%>_closing">Session closing reminder</label>
                                        <input type="checkbox" checked="checked"
                                            name="<%=Const.ParamsNames.FEEDBACK_SESSION_SENDREMINDEREMAIL%>"
                                ...
                                <div class="col-sm-4" 
                                    title="<%=Const.Tooltips.FEEDBACK_SESSION_SENDPUBLISHEDEMAIL%>" data-toggle="tooltip" data-placement="top">
                                    <div class="checkbox">
                                        <label for="<%=Const.ParamsNames.FEEDBACK_SESSION_SENDREMINDEREMAIL%>_published">Results published announcement</label>
                                        <input type="checkbox" checked="checked"
                                            name="<%=Const.ParamsNames.FEEDBACK_SESSION_SENDREMINDEREMAIL%>"
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-5 col-sm-10">
                            <button type="submit" class="btn btn-primary">Create Feedback Session</button>
                        </div>
                    </div>
            ...
            <table class="table-responsive table table-striped">
                ...
                <tr class="sessions_row" id="evaluation<%=sessionIdx%>">
                    ...
                    <td class="no-print"><%=data.getInstructorEvaluationActions(
                            edd, false)%>
                    </td>
                </tr>
                <%
