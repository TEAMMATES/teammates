                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                <input type="text" id="results-search-box" class="form-control" placeholder='<%= data.sortType.equals("question") ? "Type keywords from the question to filter results" : "Type a student/team name/tutorial group to filter results"%>' onchange="updateResultsFilter()">
