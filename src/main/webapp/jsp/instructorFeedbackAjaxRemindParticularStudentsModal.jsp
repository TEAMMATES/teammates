...
<table class="table-responsive table table-bordered">
  ...
  <c:forEach items="${data.responseStatus.getStudentsWhoDidNotRespondSorted()}" var="userToRemindEmail">
    <tr class="bg-danger">
  ...
  <c:forEach items="${data.responseStatus.getStudentsWhoRespondedSorted()}" var="userToRemindEmail">
    <tr class="bg-info">
      <td class="align-center">
        <div class="checkbox">
          <label>
