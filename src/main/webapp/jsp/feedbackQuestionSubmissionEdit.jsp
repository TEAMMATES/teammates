...
%>
    ...
    %>
                <br />
                <div class="form-group">
                    <div class="col-sm-4 form-inline" <%=(question.isRecipientNameHidden()) ? "style=\"display:none\"" : "style=\"text-align:right;\""%>>
                        <label for="input">To: </label>
                        <select class="participantSelect middlealign form-control" style="width:275px;max-width:275px"
                    ...
                    <div <%=(question.isRecipientNameHidden()) ? "class=\"col-sm-12\"" : "class=\"col-sm-8\""%>>
                ...
                <div class="form-group">
                    <div class="col-sm-4 form-inline" <%=(question.isRecipientNameHidden()) ? "style=\"display:none\"" : "style=\"text-align:right\""%>>
                        ...
                        <select class="participantSelect middlealign newResponse form-control" 
                            name="<%=Const.ParamsNames.FEEDBACK_RESPONSE_RECIPIENT%>-<%=Integer.toString(qnIndx)%>-<%=Integer.toString(responseIndx)%>"
                            <%=(numOfResponseBoxes == maxResponsesPossible) ? "style=\"display:none;width:275px;max-width:275px\"" : "style=\"width:275px;max-width:275px\""%>
                            <%=data.isSessionOpenForSubmission ? "" : "disabled=\"disabled\""%>>
                        <%
