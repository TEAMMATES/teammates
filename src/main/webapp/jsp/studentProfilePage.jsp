...
<%
    ...
    String pictureUrl = Const.ActionURIs.STUDENT_PROFILE_PICTURE +
            ...
            + data.account.studentProfile.pictureKey +
        ...
        <div id="editProfileDiv" class="well well-plain well-narrow well-sm-wide">
            ...
            <form class="form center-block" role="form" method="post" action="<%= Const.ActionURIs.STUDENT_PROFILE_EDIT_SAVE %>">
                ...
                <div class="form-group" title="<%= Const.Tooltips.STUDENT_PROFILE_EMAIL %>" data-toggle="tooltip" data-placement="top">
                    ...
                    <input id="studentEmail" name="<%= Const.ParamsNames.STUDENT_PROFILE_EMAIL %>" class="form-control" type="email" data-actual-value="<%= data.account.studentProfile.email %>" value="<%= data.account.studentProfile.email == null ? "" : data.account.studentProfile.email %>" placeholder="Contact Email (for your instructors to contact you beyond graduation)">
                </div>
                ...
                <div class="form-group">
                    ...
                    <div id="studentGender">
                        <label for="genderMale" class="radio-inline">
                            <input id="genderMale" name="<%= Const.ParamsNames.STUDENT_GENDER %>" class="radio" type="radio" value="<%= Const.GenderTypes.MALE %>" <%= data.account.studentProfile.gender.equals(Const.GenderTypes.MALE) ? "checked=\"checked\"" : "" %>> Male
                        </label>
                        <label for="genderFemale" class="radio-inline">
                            <input id="genderFemale" name="<%= Const.ParamsNames.STUDENT_GENDER %>" class="radio" type="radio" value="<%= Const.GenderTypes.FEMALE %>" <%= data.account.studentProfile.gender.equals(Const.GenderTypes.FEMALE) ? "checked=\"checked\"" : "" %>> Female
                        </label>
                        <label class="radio-inline" for="genderOther">
                            <input id="genderOther" name="<%= Const.ParamsNames.STUDENT_GENDER %>" class="radio" type="radio" value="<%= Const.GenderTypes.OTHER %>" <%= data.account.studentProfile.gender.equals(Const.GenderTypes.OTHER) ? "checked=\"checked\"" : "" %>> Not Specified
                        </label>
                    </div>
                </div>
