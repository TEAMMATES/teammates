    ...
    <ul>
      <li>
        ...
        <div class="moreInfoPointDetails">
          <ul>
            <li>
              Data can be easiely copy/pasted via external CSV
              (<a id="spreadsheet-link" href="https://docs.google.com/spreadsheets/d/1jODYiO_TcSoQ82t4E9rX-kfn1l7sEhb810rdlVJxHo0/edit?usp=sharing">Sample file</a>).
            </li>
            <li>Each existing cells can be edited by just clicking on it.</li>
            <li>Context menu is added with various shortcut options.</li>
              <ul>
                <li>Context menu can viewed by just right-clicking on the spreadsheet.</li>
                <li>Options given in context menu are add new row, undo/redo any event, text-allignment.</li>
              </ul>
              <li>Entire spreadsheet can be sorted by just clicking on the column name.</li>
              <li>Sizing handle can be used to change the size/width of column.</li>
          </ul>
        </div>
      </li>
      <li>
        <span class="moreInfoPointTitle">Column Order</span>
        <div class="moreInfoPointDetails">
          <ul>
            <li>The column order is not important.</li>
            <li>Re-arrange column just by clicking on the column header and drag them left or right.</li>
          </ul>
        </div>
      </li>
      <li>
        ...
        <div class="moreInfoPointDetails">
          <ul>
            <li class="moreInfoMassEditInfo">
              The spreadsheet above can be used for mass-editing details (except email address) of students already enrolled.
            </li>
