                            ...
                            %>
                                ...
                                <%
                                    ...
                                    for (Map.Entry<FeedbackQuestionAttributes, List<FeedbackResponseAttributes>> teamResponseEntries : currentTeamResponses.entrySet()) {
                                        ...
                                        String statsHtml = questionDetails.getQuestionResultStatisticsHtml(teamResponseEntries.getValue(), question, data.bundle, "recipient-question-giver");
                                        if(statsHtml != ""){
                                            numStatsShown++;
                                %>
        ...
        %>
                ...
                %>
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body padding-0">
                                <div class="resultStatistics">
                                    <%=questionDetails.getQuestionResultStatisticsHtml(responseEntries, question, data.bundle, "recipient-question-giver")%>
                                </div>
