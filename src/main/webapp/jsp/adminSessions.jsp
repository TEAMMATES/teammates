                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <input class="form-control col-sm-2"
                                        ...
                                        value=<%=TimeHelper.formatDate(data.getRangeStart()) %>
                                        placeholder="Date">
                                </div>
                                <div class="col-md-3">
                                    <select class="form-control"
                                        ...
                                        <%
                                            for (String opt : data.getHourOptionsAsHtml(data.getRangeStart()))
                                                out.println(opt);
                                        %>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <select class="form-control"
                                        ...
                                        <%
                                            for (String opt : data.getMinuteOptionsAsHtml(data.getRangeStart()))
                                                out.println(opt);
                                        %>
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <input class="form-control col-sm-2"
                                        ...
                                        value="<%=TimeHelper.formatDate(data.getRangeEnd())%>"
                                        placeHolder="Date">
                                </div>
                                <div class="col-md-3">
                                    <select class="form-control"
                                        ...
                                        <%
                                            for (String opt : data.getHourOptionsAsHtml(data.getRangeEnd()))
                                                out.println(opt);
                                        %>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <select class="form-control"
                                        ...
                                        <%
                                            for (String opt : data.getMinuteOptionsAsHtml(data.getRangeEnd()))
                                                out.println(opt);
                                        %>
                                    </select>
                                </div>
