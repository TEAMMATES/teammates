				...
				<tr>
					<td colspan=2 class="centeralign">
						<form id="download_eval_report" method="GET"
							...
							<%
								if(InstructorEvalResultsPageData.getInstructorStatusForEval(data.evaluationResults.evaluation).equals(Constants.INSTRUCTOR_EVALUATION_STATUS_CLOSED)) {
							%>
							...
							<%
								} else if (InstructorEvalResultsPageData.getInstructorStatusForEval(data.evaluationResults.evaluation).equals(Constants.INSTRUCTOR_EVALUATION_STATUS_PUBLISHED)) {
							%>
				...
				<table class="dataTable">
					<tr>
						...
						<th class="centeralign color_white bold" width="8%"><input
							...
							onmouseover="ddrivetip('<%=Constants.TOOLTIP_EVALUATION_DIFF%>')"
							onmouseout="hideddrivetip()">Diff</span></th>
						<th class="centeralign color_white bold" width="20%"><span
							onmouseover="ddrivetip('<%=Constants.TOOLTIP_EVALUATION_POINTS_RECEIVED%>')"
					...
					<tr class="student_row" id="student<%=idx%>">
						...
						<td class="centeralign no-print"><a class="color_black"
							...
							onmouseover="ddrivetip('<%=Constants.TOOLTIP_EVALUATION_SUBMISSION_VIEW_REVIEWER%>')"
							...
							onmouseover="ddrivetip('<%=Constants.TOOLTIP_EVALUATION_SUBMISSION_INSTRUCTOR_EDIT%>')"
