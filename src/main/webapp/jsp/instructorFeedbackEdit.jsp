                        ...
                        <span class="pull-right">
                            ...
                            <span data-toggle="tooltip" title="Copy this feedback session to other courses" data-placement="top">
                                <a class="btn btn-primary btn-sm" href="#"
                                    data-actionlink="<%= data.getFeedbackSessionEditCopyLink() %>"
                                    data-courseid="<%= data.session.courseId %>"
                                    data-fsname="<%= data.session.feedbackSessionName %>"
                                ...
                                <div class="row radio">
                                    <div class="col-md-6"
                                        ...
                                        <input type="radio"
                                            ...
                                            <%= Const.TIME_REPRESENTS_FOLLOW_OPENING.equals(data.session.sessionVisibleFromTime) ? "checked=\"checked\"" : "" %>>
                                    </div>
                                </div>
                                <div class="row radio">
                                    <div class="col-md-6"
                                        ...
                                        <input type="radio"
                                            ...
                                            value="never"
                                            <%= data.session.isPrivateSession() ? "checked=\"checked\"" : "" %>
                                            <%= Const.TIME_REPRESENTS_NEVER.equals(data.session.sessionVisibleFromTime) ? "checked=\"checked\"" : "" %>>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row radio">
                                    <div class="col-md-3"
                                        ...
                                        <input type="radio"
                                            ...
                                            <%= data.session != null &&
                                                Const.TIME_REPRESENTS_FOLLOW_VISIBLE.equals(data.session.resultsVisibleFromTime) ?
                                                "checked=\"checked\"" : "" %>>
                                    </div>
                                </div>
                                <div class="row radio">
                                ...
                                <div class="row radio">
                                    <div class="col-md-2"
                                        ...
                                        <input type="radio"
                                            ...
                                            <%= Const.TIME_REPRESENTS_NEVER.equals(data.session.resultsVisibleFromTime) ? "checked=\"checked\"" : "" %>>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <span class="pull-right">
                                    <a class="btn btn-primary btn-xs"
                                        ...
                                        onclick="getQuestionLink(<%= question.questionNumber %>)">
                                        Get Link
                                    </a>
                                    <a class="btn btn-primary btn-xs"
                                        ...
                                        onclick="enableEdit(<%= question.questionNumber %>,<%= data.questions.size() %>)">
                                        Edit
                                    </a>
                                    <a class="btn btn-primary btn-xs" style="display:none"
                                        id="<%= Const.ParamsNames.FEEDBACK_QUESTION_SAVECHANGESTEXT %>-<%= question.questionNumber %>">
                                        Save Changes
                                    </a>
                                    <a class="btn btn-primary btn-xs" style="display:none"
                                        onclick="cancelEdit(<%= question.questionNumber %>)"
                                        id="<%= Const.ParamsNames.FEEDBACK_QUESTION_CANCELEDIT %>-<%= question.questionNumber %>"
                                        data-toggle="tooltip" data-placement="top"
                            ...
                            <div class="visibilityOptions" id="visibilityOptions-<%= question.questionNumber %>">
                                <table class="dataTable participantTable table table-striped text-center background-color-white">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="visibilityCheckbox answerCheckbox<%= question.questionNumber %> centered"
                                                name="receiverLeaderCheckbox" type="checkbox"
                                                value="<%= FeedbackParticipantType.RECEIVER %>" disabled="disabled"
                                                <%= question.showResponsesTo.contains(FeedbackParticipantType.RECEIVER)? "checked=\"checked\"" : "" %>>
                                        </td>
                                        <td>
                                            <input class="visibilityCheckbox giverCheckbox<%= question.questionNumber %>"
                                                ...
                                                <%= question.showGiverNameTo.contains(FeedbackParticipantType.RECEIVER) ? "checked=\"checked\"" : "" %>>
                                        </td>
                                        <td>
                                            <input class="visibilityCheckbox recipientCheckbox<%= question.questionNumber %>"
                                                name="receiverFollowerCheckbox" type="checkbox"
                                                value="<%= FeedbackParticipantType.RECEIVER %>" disabled="disabled"
                                                <%= question.showRecipientNameTo.contains(FeedbackParticipantType.RECEIVER) ? "checked=\"checked\"" : "" %>>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-left">
                                        ...
                                        <td>
                                            <input class="visibilityCheckbox answerCheckbox<%= question.questionNumber %>"
                                                ...
                                                <%= question.showResponsesTo.contains(FeedbackParticipantType.OWN_TEAM_MEMBERS) ? "checked=\"checked\"" : "" %>>
                                        </td>
                                        <td>
                                            <input class="visibilityCheckbox giverCheckbox<%= question.questionNumber %>"
                                                type="checkbox" value="<%= FeedbackParticipantType.OWN_TEAM_MEMBERS %>" disabled="disabled"
                                                <%= question.showGiverNameTo.contains(FeedbackParticipantType.OWN_TEAM_MEMBERS) ? "checked=\"checked\"" : "" %>>
                                        </td>
                                        <td>
                                            <input class="visibilityCheckbox recipientCheckbox<%= question.questionNumber %>"
                                                type="checkbox" value="<%= FeedbackParticipantType.OWN_TEAM_MEMBERS %>" disabled="disabled"
                                                <%= question.showRecipientNameTo.contains(FeedbackParticipantType.OWN_TEAM_MEMBERS) ? "checked=\"checked\"" : "" %>>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-left">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <a class="btn btn-primary"
                            href="<%= Const.ActionURIs.INSTRUCTOR_FEEDBACKS_PAGE + "?" +
                            Const.ParamsNames.USER_ID + "=" + data.account.googleId + "&" +
                            Const.ParamsNames.COURSE_ID + "=" + data.session.courseId + "&" +
                            Const.ParamsNames.FEEDBACK_SESSION_NAME + "=" + data.session.feedbackSessionName %>">
                            &nbsp;&nbsp;&nbsp;Done Editing&nbsp;&nbsp;&nbsp;
                        </a>
                    </div>
                </div>
