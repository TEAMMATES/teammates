...
<%
	InstructorCourseJoinConfirmationPageData data = (InstructorCourseJoinConfirmationPageData) request.getAttribute("data");
%>
<!DOCTYPE html>
<html>
<head>
	...
	<div id="frameBody">
		<div id="frameBodyWrapper">
			...
			<div id="headerOperation">
				<h1>Instructor Course Join Confirmation</h1>
			</div>
