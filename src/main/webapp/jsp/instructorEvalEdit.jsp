...
<body>
	...
	<div id="frameBody">
		<div id="frameBodyWrapper">
			...
			<form method="post" action="<%=Config.PAGE_INSTRUCTOR_EVAL_EDIT_SAVE%>" name="form_addevaluation">
				<table class="inputTable" id="instructorEvaluationManagement">
					<tr>
						<td class="label bold" >Course ID:</td>
						<td style="vertical-align: middle;">
							<input type="hidden" name="<%=Config.PARAM_COURSE_ID%>" value="<%=data.evaluation.courseId%>">
					...
					<tr>
						...
						<td style="vertical-align: middle;">
							<input type="hidden" name="<%=Config.PARAM_EVALUATION_NAME%>" value="<%=InstructorEvalEditPageData.escapeForHTML(data.evaluation.name)%>">
					...
					<tr>
						...
						<td><select style="width: 100px;" name="<%=Config.PARAM_EVALUATION_TIMEZONE%>" id="<%=Config.PARAM_EVALUATION_TIMEZONE%>"
							...
							<input type="hidden" name="<%=Config.PARAM_EVALUATION_TIMEZONE%>" value="<%=data.evaluation.timeZone%>">
						</td>
					</tr>
					<tr>
					<td></td>
