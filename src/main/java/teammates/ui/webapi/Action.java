...
public abstract class Action {
    ...
    /**
     * Executes logic that should run after the database transaction is committed.
     *
     * <p>This is useful for side effects like task queueing that depend on committed data.</p>
     */
