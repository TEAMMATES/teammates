...
public class ActionFactory {
    ...
    static {
        ...
        map(ResourceURIs.DATABUNDLE_SEARCH, POST, PutDataBundleDocumentsAction.class);
        ...
        map(ResourceURIs.STUDENT_UNIQUE_LINKS_REGENERATION, POST, RegenerateStudentCourseLinksAction.class);
