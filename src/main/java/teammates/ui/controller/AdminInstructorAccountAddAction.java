...
public class AdminInstructorAccountAddAction extends Action {
    ...
    protected ActionResult execute() {
        ...
        data.statusForAjax = "Instructor " + Sanitizer.sanitizeForHtml(data.instructorName)
        ...
        statusToAdmin = "A New Instructor <span class=\"bold\">"
                + Sanitizer.sanitizeForHtmlTag(data.instructorName) + "</span> has been created.<br>"
                + "<span class=\"bold\">Id: </span>"
                + "ID will be assigned when the verification link was clicked and confirmed"
                + "<br>"
                + "<span class=\"bold\">Email: </span>" + Sanitizer.sanitizeForHtmlTag(data.instructorEmail)
                + "<span class=\"bold\">Institution: </span>"
                + Sanitizer.sanitizeForHtmlTag(data.instructorInstitution);
