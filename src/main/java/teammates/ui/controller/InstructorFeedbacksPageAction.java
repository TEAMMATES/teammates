...
public class InstructorFeedbacksPageAction extends Action {
    ...
    protected ActionResult execute() throws EntityDoesNotExistException {
        ...
        //This can be null. Non-null value indicates the page is being loaded
        //to add a feedback to the specified course
        String feedbackSessionNameForNewSession = getRequestParamValue(Const.ParamsNames.FEEDBACK_SESSION_NAME);
        ...
        data.feedbackSessionNameForNewSession = feedbackSessionNameForNewSession;
