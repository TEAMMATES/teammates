        ...
        for (int questionIndx = 1; questionIndx <= numOfQuestionsToGet; questionIndx++) {
            ...
            for (int responseIndx = 0; responseIndx < numOfResponsesToGet; responseIndx++) {
                ...
                if (response.responseMetaData.getValue().isEmpty()) {
                    ...
                    response.giver = questionAttributes.giverType.isTeam()
                            || questionAttributes.giverType == FeedbackParticipantType.CUSTOM
                                    && questionAttributes.isFeedbackPathsGiverTypeTeams() ? userTeamForCourse
                                                                                          : userEmailForCourse;
