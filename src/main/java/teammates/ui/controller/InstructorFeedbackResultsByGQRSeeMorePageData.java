...
public class InstructorFeedbackResultsByGQRSeeMorePageData extends PageData {
    ...
    public InstructorFeedbackResultsByGQRSeeMorePageData(AccountAttributes account) {
        super(account);
