...
public class InstructorFeedbackResultsByQuestionSeeMorePageData extends PageData {
    ...
    public InstructorFeedbackResultsByQuestionSeeMorePageData(AccountAttributes account) {
        super(account);
