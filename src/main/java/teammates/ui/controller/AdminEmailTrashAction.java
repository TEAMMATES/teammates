...
public class AdminEmailTrashAction extends Action {
    ...
    protected ActionResult execute() {
        ...
        if (emailId == null || emailId.isEmpty()) {
            statusToAdmin.add("Invalid parameter : email id cannot be null or empty");
        ...
        if (requestUrl.contains(Const.ActionURIs.ADMIN_EMAIL_MOVE_TO_TRASH)) {
            try {
                ...
                statusToAdmin.add("Email with id" + emailId + " has been moved to trash bin");
            ...
            try {
                ...
                statusToAdmin.add("Email with id" + emailId + " has been moved out of trash bin");
