...
public enum ResourceEndpoints {
    ...
    STUDENT_SESSIONS(ResourceURIs.STUDENT_SESSIONS),
    QUESTIONS(ResourceURIs.QUESTIONS),
    QUESTION(ResourceURIs.QUESTION),
    STUDENT_RESPONSES(ResourceURIs.STUDENT_RESPONSES),
    INSTRUCTOR_RESPONSES(ResourceURIs.INSTRUCTOR_RESPONSES),
    ...
    JOIN_KEY_ACCESS(ResourceURIs.JOIN_KEY_ACCESS),
