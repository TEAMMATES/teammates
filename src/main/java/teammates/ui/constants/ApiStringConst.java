...
public enum ApiStringConst {
    ...
    /**
     * Escape regex pattern strings to ensure the pattern remains valid when
     * converted to JS.
     */
    private static String escapeRegex(String regexStr) {
        ...
        // Replace possessive zero or more times quantifier *+ that the email pattern
        // uses
