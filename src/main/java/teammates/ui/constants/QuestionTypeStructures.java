...
public enum QuestionTypeStructures {
    ...
    DEFAULT_CONTRIBUTION_QUESTION_DETAILS(new FeedbackContributionQuestionDetails("", false)),
    DEFAULT_OLD_CONTRIBUTION_QUESTION_DETAILS(new FeedbackContributionQuestionDetails("", true)),
