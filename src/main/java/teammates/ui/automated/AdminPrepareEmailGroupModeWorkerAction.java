...
public class AdminPrepareEmailGroupModeWorkerAction extends AutomatedAction {
    ...
    public void execute() {
        ...
        String groupReceiverListFileKey = getNonNullRequestParamValue(ParamsNames.ADMIN_EMAIL_GROUP_RECEIVER_LIST_FILE_KEY);

        String indexOfEmailListToResumeAsString = getRequestParamValue(ParamsNames.ADMIN_GROUP_RECEIVER_EMAIL_LIST_INDEX);
