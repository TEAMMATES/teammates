...
public class FeedbackSubmittedConfirmationEmailServlet extends
        WorkerServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp) {
        ...
        String userToSendConfirmationEmail = HttpRequestHelper
                .getValueFromRequestParameterMap(req, ParamsNames.SUBMISSION_CONFIRM_USER);
        
        try {
            FeedbackSessionsLogic.inst()
                    .sendConfirmationEmailForSubmission(courseId,
                            feedbackSessionName, userToSendConfirmationEmail);
