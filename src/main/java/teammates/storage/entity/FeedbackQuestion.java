...
public class FeedbackQuestion extends BaseEntity {
    ...
    /**
     * Gets the question id, in legacy key format similar to that generated by the old appengine SDK.
     */
    public String getId() {
        String untrimmedId = Key.create(FeedbackQuestion.class, feedbackQuestionId).toLegacyUrlSafe();

        // Trim last 4 characters for backward compatibility of keys that were generated before Objectify V6
