...
public class Comment {
    ...
    public Comment(String courseId, String giverEmail, CommentParticipantType recipientType, Set<String> recipients, CommentStatus status,
            CommentSendingState sendingState,
            List<CommentParticipantType> showCommentTo,
            List<CommentParticipantType> showGiverNameTo,
            List<CommentParticipantType> showRecipientNameTo,
            Text comment, Date date, String lastEditorEmail, Date lastEditedAt){
