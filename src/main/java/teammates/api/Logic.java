...
public class Logic {
	...
	void createSubmissions(List<SubmissionData> submissionDataList) {
	...
	void editStudentAsJson(String originalEmail, String newValues)
	...
	void editEvaluationAsJson(String evaluationJson)
			throws InvalidParametersException, EntityDoesNotExistException {
	...
	void editSubmissionAsJson(String submissionJson) throws InvalidParametersException, EntityDoesNotExistException {
	...
	void editTfsAsJson(String tfsJson)
			throws EntityDoesNotExistException {
	...
	void editTeamProfileAsJson(String originalTeamName,
