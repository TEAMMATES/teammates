...
public class Logic {
    ...
    public void deleteInstructorDocument(String courseId, String email) {
        usersLogic.deleteInstructorDocument(courseId, email);
    }
     ...
     */
    public void deleteAccountRequestDocument(UUID id) {
        accountRequestLogic.deleteDocument(id);
    }
    ...
    public void deleteStudentDocument(String courseId, String email) {
        usersLogic.deleteStudentDocument(courseId, email);
    }
