...
public final class CoursesLogic {
     ...
     *
     * <br/>Preconditions: <br/>
     * * {@code instructorAccountId} maps to an account with instructor privileges.
     */
    public void createCourseAndInstructor(UUID instructorAccountId, Course courseToCreate)
            throws InvalidParametersException, EntityAlreadyExistsException {

        Account courseCreator = accountsLogic.getAccount(instructorAccountId);
        assert courseCreator != null : "Trying to create a course for a non-existent instructor account:" + instructorAccountId;
