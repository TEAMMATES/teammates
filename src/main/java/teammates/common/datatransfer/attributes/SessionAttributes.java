...
public interface SessionAttributes {
     ...
     */
   static final Comparator<SessionAttributes> ASCENDING_ORDER = (SessionAttributes session1, SessionAttributes session2) -> {
     ...
     * end time, followed by start time and session name.
     */
    static final Comparator<SessionAttributes> DESCENDING_ORDER = (SessionAttributes session1, SessionAttributes session2) -> {
