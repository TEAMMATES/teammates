...
/**
 * Represents a data transfer object for {@link FeedbackResponseComment}
 * entities.
 */
public class FeedbackResponseCommentAttributes extends EntityAttributes {
    ...
    public FeedbackResponseCommentAttributes(FeedbackResponseComment comment) {
        ...
        this.sendingState = comment.getSendingState() == null ? CommentSendingState.SENT
                : comment.getSendingState();
        ...
        this.lastEditedAt = comment.getLastEditedAt() == null ? comment.getCreatedAt()
    ...
    public static void sortFeedbackResponseCommentsByCreationTime(
            List<FeedbackResponseCommentAttributes> frcs) {
