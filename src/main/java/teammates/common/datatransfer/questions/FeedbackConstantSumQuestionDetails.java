...
public class FeedbackConstantSumQuestionDetails extends FeedbackQuestionDetails {
    ...
    public boolean extractQuestionDetails(
        ...
        if (distributeToRecipients) {
            this.setConstantSumQuestionDetails(pointsPerOption, points, forceUnevenDistribution,
                    minPoints, maxPoints, distributePointsOption);
        } else {
    ...
    private void setConstantSumQuestionDetails(
            List<String> constSumOptions, boolean pointsPerOption, int points, boolean unevenDistribution,
    ...
    public List<String> validateQuestionDetails(String courseId) {
        ...
        if (minPointsConstraint != NO_MIN_MAX_CONSTRAINT && minPointsConstraint < 0) {
            errors.add(Const.FeedbackQuestion.CONST_SUM_ERROR_MIN_POINTS_CONSTRAINT_LESS_THAN_ZERO);
        }

        if (maxPointsConstraint != NO_MIN_MAX_CONSTRAINT && maxPointsConstraint < 1) {
            errors.add(Const.FeedbackQuestion.CONST_SUM_ERROR_MAX_POINTS_CONSTRAINT_LESS_THAN_ONE);
        }
