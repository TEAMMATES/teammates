...
public class FeedbackMcqQuestionDetails extends FeedbackQuestionDetails {
        ...
        for (int i = 0; i < choices.size(); i++) {
            String optionFragment =
                    FeedbackQuestionFormTemplates.populateTemplate(optionFragmentTemplate,
                            ...
                            Const.FeedbackQuestion.CHECKED, existingMcqResponse.getAnswerString().equals(choices.get(i)) ? "checked" : "",
        ...
        for (int i = 0; i < numOfMcqChoices; i++) {
            String optionFragment =
                    FeedbackQuestionFormTemplates.populateTemplate(optionFragmentTemplate,
                            ...
                            Const.FeedbackQuestion.MCQ_CHOICE_VALUE,  Sanitizer.sanitizeForHtml(mcqChoices.get(i)),
    ...
    public String getQuestionAdditionalInfoHtml(int questionNumber, String additionalInfoId) {
        ...
        if (otherEnabled) {
            String optionFragment =
                    FeedbackQuestionFormTemplates.populateTemplate(optionFragmentTemplate, Const.FeedbackQuestion.MCQ_CHOICE_VALUE, "Others");
            optionListHtml.append(optionFragment);
        }
    ...
    public String getQuestionResultStatisticsHtml(List<FeedbackResponseAttributes> responses,
        ...
        for (Entry<String, Integer> entry : answerFrequency.entrySet()) {
            fragments.append(FeedbackQuestionFormTemplates.populateTemplate(FeedbackQuestionFormTemplates.MCQ_RESULT_STATS_OPTIONFRAGMENT,
                                Const.FeedbackQuestion.MCQ_CHOICE_VALUE,  Sanitizer.sanitizeForHtml(entry.getKey()),
