...
public enum EmailType {
    ...
    NEW_ACCOUNT_VERIFICATION_REQUEST_ADMIN_ALERT("TEAMMATES (Action Needed): New Account Request Received"),
    NEW_ACCOUNT_VERIFICATION_REQUEST_ACKNOWLEDGEMENT("TEAMMATES: Acknowledgement of Instructor Account Request"),
    ACCOUNT_VERIFICATION_REQUEST_REJECTION("TEAMMATES: %s"),
