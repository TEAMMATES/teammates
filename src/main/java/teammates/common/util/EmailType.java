...
public enum EmailType {
    ...
    STUDENT_COURSE_REJOIN_AFTER_ACCOUNT_RESET("TEAMMATES: Your account has been reset for course [%s][Course ID: %s]"),
    ...
    INSTRUCTOR_COURSE_REJOIN_AFTER_ACCOUNT_RESET("TEAMMATES: Your account has been reset for course [%s][Course ID: %s]"),
