...
public class LogMessageGenerator {
     ...
     * @param logMessages list of log message to show to admin
    ...
    public String generatePageActionLogMessage(String url, Map<String, String[]> params, UserType currUser,
            AccountAttributes userAccount, StudentAttributes unregisteredStudent, List<String> logMessages) {
        ...
        builder.generateMessage(logMessages);
