...
public final class Config {
    ...
    /** Value of {@code app.oidc.provider}. */
    ...
    /** Value of {@code app.oidc.google.issuer}. */
    public static final String OIDC_GOOGLE_ISSUER;
    ...
    static {
        ...
        OIDC_PROVIDER = getProperty(properties, devProperties, "app.oidc.provider");
        ...
        OIDC_GOOGLE_ISSUER = getProperty(properties, devProperties, "app.oidc.google.issuer");
