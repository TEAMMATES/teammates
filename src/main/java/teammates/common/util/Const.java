...
public class Const {
    ...
    public class StatusMessages{
        ...
        public static final String STUDENT_FIRST_TIME = "<div style=\"background: linear-gradient(to bottom,#fcf8e3 0,#e3d691 100%);\"><div style=\"padding: 10px 30px;font-family:'Calibri';\">"
                + "<h2 style=\"width: 100%; text-align:center;font-family: 'Segoe UI Light';color:red;\" > Oops! Your Google account is not known to TEAMMATES.</h2>"
                + "<br/><br/><strong style=\"margin: 10px 0px;font-size: 1.2em;\">To access a course on TEAMMATES, first you need to wait till an instructor adds you to that course and TEAMMATES sends you instructions on how to access that particular course in TEAMMATES.</strong> "
                + "<br/><br/><strong style = \"margin: 10px 0px;font-size: 1.2em;\">If you 'joined' the course in TEAMMATES using a Google account before, but cannot login anymore, these are the possible reasons:</strong>"
                + "<ul style = \"list-style: none;padding: 0;margin: 0; font-size: 1.1em;\">"
                + "<br/><li style = \"margin: 10px auto\">1.  You used a different Google account to access TEAMMATES in the past. "
                ...
                + "If you don't remember which Google account you used previously, email us from the same email account to which you receive TEAMMATES emails.</li>"
                + "<br/><li style = \"margin: 10px auto\">2. You changed the primary email from a non-Gmail address to a Gmail address recently. " 
                ...
                + "<br/><li style = \"margin: 10px auto\">3. You joined this course just a few seconds ago and your data may be still in the process of propagating through our servers. "
