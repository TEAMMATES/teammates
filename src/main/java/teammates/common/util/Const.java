...
public class Const {
    ...
    public class StatusMessages{
        ...
        public static final String UNREGISTERED_STUDENT_MESSAGE = "You may submit feedback for sessions that are currently open "
                + "and view results without logging in. To access other features you need <a href='%s' class='link'>to login "
                + "using a Google account</a> (recommended).";
