...
public class Const {
    ...
    public class StatusMessages{
        ...
        public static final String INSTRUCTOR_PERSISTENCE_ISSUE = "Account creation is still in progress. Please reload the page"
                + " after sometime.";
        public static final String INSTRUCTOR_NO_MODIFY_PERMISSION_FOR_ACTIVE_COURSES_SESSIONS = "No permission to modify course's sessions!";
        public static final String INSTRUCTOR_NO_ACTIVE_COURSES = "No active courses!";
