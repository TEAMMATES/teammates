...
public final class Const {
    ...
    public static class Actions {
        public static final String PUT_DATA_BUNDLE_ACTION = "PutDataBundleAction";
        public static final String DELETE_DATA_BUNDLE_ACTION = "DeleteDataBundleAction";
        public static final String PUT_DATA_BUNDLE_DOCUMENTS_ACTION = "PutDataBundleDocumentsAction";
        public static final String ADMIN_EXCEPTION_TEST_ACTION = "AdminExceptionTestAction";
        public static final String SEND_ERROR_REPORT_ACTION = "SendErrorReportAction";
        public static final String GET_TIME_ZONES_ACTION = "GetTimeZonesAction";
        public static final String GET_NATIONALITIES_ACTION = "GetNationalitiesAction";
        public static final String GET_AUTH_INFO_ACTION = "GetAuthInfoAction";
        public static final String GET_REGKEY_VALIDITY_ACTION = "GetRegkeyValidityAction";
        public static final String GET_ACCOUNT_ACTION = "GetAccountAction";
        public static final String CREATE_ACCOUNT_ACTION = "CreateAccountAction";
        public static final String DELETE_ACCOUNT_ACTION = "DeleteAccountAction";
        public static final String DOWNGRADE_ACCOUNT_ACTION = "DowngradeAccountAction";
        public static final String RESET_ACCOUNT_ACTION = "ResetAccountAction";
        public static final String GET_COURSE_ACTION = "GetCourseAction";
        public static final String DELETE_COURSE_ACTION = "DeleteCourseAction";
        public static final String CREATE_COURSE_ACTION = "CreateCourseAction";
        public static final String UPDATE_COURSE_ACTION = "UpdateCourseAction";
        public static final String ARCHIVE_COURSE_ACTION = "ArchiveCourseAction";
        public static final String BIN_COURSE_ACTION = "BinCourseAction";
        public static final String RESTORE_COURSE_ACTION = "RestoreCourseAction";
        public static final String GET_COURSES_ACTION = "GetCoursesAction";
        public static final String GET_COURSE_SECTION_NAMES_ACTION = "GetCourseSectionNamesAction";
        public static final String GET_INSTRUCTORS_ACTION = "GetInstructorsAction";
        public static final String GET_INSTRUCTOR_ACTION = "GetInstructorAction";
        public static final String DELETE_INSTRUCTOR_ACTION = "DeleteInstructorAction";
        public static final String GET_INSTRUCTOR_PRIVILEGE_ACTION = "GetInstructorPrivilegeAction";
        public static final String UPDATE_INSTRUCTOR_PRIVILEGE_ACTION = "UpdateInstructorPrivilegeAction";
        public static final String CREATE_FEEDBACK_RESPONSE_COMMENT_ACTION = "CreateFeedbackResponseCommentAction";
        public static final String GET_FEEDBACK_RESPONSE_COMMENT_ACTION = "GetFeedbackResponseCommentAction";
        public static final String UPDATE_FEEDBACK_RESPONSE_COMMENT_ACTION = "UpdateFeedbackResponseCommentAction";
        public static final String DELETE_FEEDBACK_RESPONSE_COMMENT_ACTION = "DeleteFeedbackResponseCommentAction";
        public static final String GET_SESSION_RESULTS_ACTION = "GetSessionResultsAction";
        public static final String GET_STUDENTS_ACTION = "GetStudentsAction";
        public static final String ENROLL_STUDENTS_ACTION = "EnrollStudentsAction";
        public static final String DELETE_STUDENTS_ACTION = "DeleteStudentsAction";
        public static final String DELETE_STUDENT_ACTION = "DeleteStudentAction";
        public static final String GET_STUDENT_ACTION = "GetStudentAction";
        public static final String UPDATE_STUDENT_ACTION = "UpdateStudentAction";
        public static final String SEARCH_INSTRUCTORS_ACTION = "SearchInstructorsAction";
        public static final String SEARCH_STUDENTS_ACTION = "SearchStudentsAction";
        public static final String GENERATE_EMAIL_ACTION = "GenerateEmailAction";
        public static final String GET_ONGOING_SESSIONS_ACTION = "GetOngoingSessionsAction";
        public static final String GET_SESSION_RESPONSE_STATS_ACTION = "GetSessionResponseStatsAction";
        public static final String GET_FEEDBACK_SESSION_ACTION = "GetFeedbackSessionAction";
        public static final String UPDATE_FEEDBACK_SESSION_ACTION = "UpdateFeedbackSessionAction";
        public static final String CREATE_FEEDBACK_SESSION_ACTION = "CreateFeedbackSessionAction";
        ...
        public static final String BIN_FEEDBACK_SESSION_ACTION = "BinFeedbackSessionAction";
        public static final String RESTORE_FEEDBACK_SESSION_ACTION = "RestoreFeedbackSessionAction";
        public static final String REGENERATE_STUDENT_COURSE_LINKS_ACTION = "RegenerateStudentCourseLinksAction";
        public static final String GET_FEEDBACK_QUESTIONS_ACTION = "GetFeedbackQuestionsAction";
        public static final String CREATE_FEEDBACK_QUESTION_ACTION = "CreateFeedbackQuestionAction";
        public static final String UPDATE_FEEDBACK_QUESTION_ACTION = "UpdateFeedbackQuestionAction";
        public static final String DELETE_FEEDBACK_QUESTION_ACTION = "DeleteFeedbackQuestionAction";
        public static final String GET_FEEDBACK_QUESTION_RECIPIENTS_ACTION = "GetFeedbackQuestionRecipientsAction";
        public static final String GET_FEEDBACK_RESPONSES_ACTION = "GetFeedbackResponsesAction";
        public static final String SUBMIT_FEEDBACK_RESPONSES_ACTION = "SubmitFeedbackResponsesAction";
        public static final String GET_HAS_RESPONSES_ACTION = "GetHasResponsesAction";
        public static final String GET_LOCAL_DATE_TIME_INFO_ACTION = "GetLocalDateTimeInfoAction";
        public static final String SESSION_LINKS_RECOVERY_ACTION = "SessionLinksRecoveryAction";
        public static final String GET_COURSE_JOIN_STATUS_ACTION = "GetCourseJoinStatusAction";
        public static final String JOIN_COURSE_ACTION = "JoinCourseAction";
        public static final String SEND_JOIN_REMINDER_EMAIL_ACTION = "SendJoinReminderEmailAction";
        public static final String GET_STUDENT_PROFILE_ACTION = "GetStudentProfileAction";
        public static final String UPDATE_STUDENT_PROFILE_ACTION = "UpdateStudentProfileAction";
        public static final String GET_STUDENT_PROFILE_PICTURE_ACTION = "GetStudentProfilePictureAction";
        public static final String POST_STUDENT_PROFILE_PICTURE_ACTION = "PostStudentProfilePictureAction";
        public static final String DELETE_STUDENT_PROFILE_PICTURE_ACTION = "DeleteStudentProfilePictureAction";
        public static final String UPDATE_INSTRUCTOR_ACTION = "UpdateInstructorAction";
        public static final String CREATE_INSTRUCTOR_ACTION = "CreateInstructorAction";
        public static final String CREATE_FEEDBACK_SESSION_LOG_ACTION = "CreateFeedbackSessionLogAction";
        public static final String GET_FEEDBACK_SESSION_LOGS_ACTION = "GetFeedbackSessionLogsAction";
        public static final String QUERY_LOGS_ACTION = "QueryLogsAction";
        public static final String COMPILE_LOGS_ACTION = "CompileLogsAction";
        public static final String DATASTORE_BACKUP_ACTION = "DatastoreBackupAction";
        public static final String FEEDBACK_SESSION_OPENING_REMINDERS_ACTION = "FeedbackSessionOpeningRemindersAction";
