...
public class Const {
    ...
    public class StatusMessages{
        ...
        public static final String FEEDBACK_SESSION_NOT_UNPUBLISHABLE = "The feedback session cannot be unpublished. Probably it has already been unpublished, or it's a private session.";
