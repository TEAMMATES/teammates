...
public class Const {
    ...
    public class StatusMessages{
        ...
        public static final String STUDENT_FIRST_TIME = "<p align='center'><font  color='red'><b>Oops! Your Google account is" 
                                        +"not known to TEAMMATES.<b></font></p><br><div style=\"text-align:left;\">"
                                        + "<br/>To access a course on TEAMMATES, first you need to wait till an instructor adds you to that course and" 
                                        +"TEAMMATES sends you instructions on how to access that particular course in TEAMMATES."
                                        +"<br/><br/>If you 'joined' the course in TEAMMATES using a Google account before, but cannot login anymore, "
                                        ...
                                        + "If you don't remember which Google account you used previously, email us from the same email account to"
                                        +"which you receive TEAMMATES emails."
                                        + "<br/>2. You changed the primary email from a non-Gmail address to a Gmail address recently. " 
                                        + "In that case, <a href='http://www.comp.nus.edu.sg/%7Eteams/contact.html'>email us</a> so that we can"
                                        +"reconfigure your account to use the new Gmail address."
                                        + "<br/>3. You joined this course just a few seconds ago and your data may be still in the process of"
                                        +"propagating through our servers. "
                                        + "In that case, please click on the <a href=" + ActionURIs.STUDENT_HOME_PAGE + ">Home</a> link above in"
                                        +"a few minutes. </div>";
