...
public class Const {
    ...
    public class StatusMessages{
        ...
        public static final String STUDENT_UPDATE_PROFILE_SHORTNAME = "Meanwhile, you can provide a preferred name that you would prefer to be called by <a href=\"" + Const.ActionURIs.STUDENT_PROFILE_PAGE + "\">here</a>.";
