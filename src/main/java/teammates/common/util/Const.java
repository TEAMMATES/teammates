...
public class Const {
    ...
    public static class FeedbackQuestion{
        ...
        public static final String RUBRIC_ERROR_INVALID_WEIGHT = "The weights for the choices of a " + Const.FeedbackQuestionTypeNames.RUBRIC + " must be valid numbers with precision up to 2 decimal places.";
    }
