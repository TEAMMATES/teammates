...
public final class Const {
    ...
    public static class StatusMessages {
        ...
        public static final String STUDENT_FIRST_TIME = "<div class='align-left'>"
                ...
                + "<ol><li>You used a different Google account to access TEAMMATES in the past. "
                ...
                + "email us from the same email account to which you receive TEAMMATES emails.</li>"
                
                + "<li>You changed the primary email from a non-Gmail address to a Gmail address recently. "
                + "In that case, <a href=\"/contact.jsp\">email us</a> "
                + "so that we can reconfigure your account to use the new Gmail address.</li>"
