...
public class Const {
    ...
    public class ParamsNames{
        ...
        public static final String COPIED_COURSES_ID = "coursestocopyto";
    ...
    public class StatusMessages{
        ...
        public static final String FEEDBACK_SESSION_COPY_ALREADYEXISTS = "A feedback session with the name %s already exists in the course %s.";
