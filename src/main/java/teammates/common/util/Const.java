...
public class Const {
    ...
    public class StatusMessages{
        ...
        public static final String STUDENT_FIRST_TIME = "<p align='center'><font  color='red'><b>Oops! Your Google account is not known to TEAMMATES.<b></font></p><br><div style=\"text-align:left;\">"
                + "<br/>To access a course on TEAMMATES, first you need to wait till an instructor adds you to that course and TEAMMATES sends you instructions on how to access that particular course in TEAMMATES."+
                "<br/><br/>If you 'joined' the course in TEAMMATES using a Google account before, but cannot login anymore, these are the possible reasons:"
