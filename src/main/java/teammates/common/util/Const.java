...
public class Const {
    ...
    public class StatusMessages{
        ...
        public static final String FEEDBACK_SUBMISSIONS_NOT_OPEN = "<strong>The feedback session is currently closed.</strong> You can view the questions and any submitted responses for this feedback session but cannot submit new responses.";
