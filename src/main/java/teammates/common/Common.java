...
public class Common {
	...
	public static final String MESSAGE_STUDENT_FIRST_TIME = "Welcome stranger :-) "
			...
			+ "<br/><br/>In that case, <a href='http://www.comp.nus.edu.sg/%7Eteams/contact.html'>email us</a> so that we can reconfigure your account to use the new Gmail address. ";
