...
public class VerifyCourseEntityAttributes
    ...
    private boolean verifyFeedbackSession(teammates.storage.entity.FeedbackSession oldSession,
        ...
        boolean doFieldsMatch = newSession.getCourse().getId().equals(oldSession.getCourseId())
                ...
                && newSession.isOpenedEmailEnabled() == oldSession.isOpenedEmailEnabled()
                && newSession.isClosingSoonEmailEnabled() == oldSession.isClosingSoonEmailEnabled()
                && newSession.isOpenedEmailSent() == oldSession.isSentOpenedEmail()
                ...
                && newSession.isClosingSoonEmailSent() == oldSession.isSentClosingSoonEmail()
                ...
                && Objects.equals(newSession.getDeletedAt(), oldSession.getDeletedTime());
        if (!doFieldsMatch) {
    ...
    private boolean verifyFeedbackResponse(FeedbackResponse oldResponse,
        ...
        boolean allFieldsMatch = newResponse.getGiver().equals(oldResponse.getGiverEmail())
                && Objects.equals(newGiverCourseId, oldResponse.getCourseId())
                && Objects.equals(newGiverSectionName, oldResponse.getGiverSection())
                && newResponse.getRecipient().equals(oldResponse.getRecipientEmail())
                && Objects.equals(newRecipientSectionName, oldResponse.getRecipientSection())
    ...
    private boolean verifyFeedbackResponseComment(FeedbackResponseComment oldComment,
        ...
        return newComment.getGiver().equals(oldComment.getGiverEmail())
                ...
                && Objects.equals(newCommentCourseId, oldComment.getCourseId())
                && Objects.equals(newCommentGiverSection, oldComment.getGiverSection())
                && Objects.equals(newCommentRecipientSection, oldComment.getReceiverSection())
    ...
    private boolean verifyDeadlineExtension(DeadlineExtension oldDeadline,
        ...
        return newDeadline.getFeedbackSession().getName().equals(oldDeadline.getFeedbackSessionName())
                ...
                && newDeadline.isClosingSoonEmailSent() == oldDeadline.getSentClosingSoonEmail()
