...
public class InstructorSearchPageE2ETest extends BaseE2ETestCase {
        ...
        public void testAll() {
                ...
                // The table is sorted by section > team > name (ascending) by default.
                Student[] studentsInCourse1 = sortBySectionTeamName(
                                testData.students.get("student2InCourse1"),
                                testData.students.get("student2.2InCourse1"));
                Student[] studentsInCourse2 = sortBySectionTeamName(
                ...
                InstructorCourseStudentDetailsViewPageSql studentDetailsViewPage = searchPage.clickViewStudent(course1,
                                studentEmail);
                ...
                InstructorCourseStudentDetailsEditPageSql studentDetailsEditPage = searchPage.clickEditStudent(course1,
                                studentEmail);
                ...
                InstructorStudentRecordsPageSql studentRecordsPage = searchPage.clickViewAllRecords(course1,
                                studentEmail);
        ...
        private Student[] sortBySectionTeamName(Student... students) {
                return Arrays.stream(students)
                                .sorted(Comparator
                                                .comparing(Student::getSectionName,
                                                                Comparator.nullsFirst(Comparator.naturalOrder()))
                                                .thenComparing(Student::getTeamName,
                                                                Comparator.nullsFirst(Comparator.naturalOrder()))
