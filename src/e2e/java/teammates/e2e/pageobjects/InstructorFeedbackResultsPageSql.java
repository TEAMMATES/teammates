...
public class InstructorFeedbackResultsPageSql extends AppPage {
    ...
    public void verifySessionDetails(FeedbackSession feedbackSession, Course course) {
    ...
    private String[] getExpectedGqrDetails(FeedbackQuestion question,
        ...
        if (response.getFeedbackQuestion().getFeedbackSession() == null) {
    ...
    private String getSessionDurationString(FeedbackSession feedbackSession, Course course) {
        return getDateString(feedbackSession.getStartTime(), course.getTimeZone()) + "   to\n"
                + getDateString(feedbackSession.getEndTime(), course.getTimeZone());
    }
    ...
    private boolean isMissingResponse(FeedbackResponse response) {
        return response.getFeedbackQuestion().getFeedbackSession() == null;
    }
