...
public class AdminHomePageNew extends AppPageNew {
    ...
    public AdminHomePageNew(Browser browser) {
        super(browser);
    }
     ...
     */
    public AdminHomePageNew createInstructor(InstructorAttributes attributesForNewAccount, String institute) {
