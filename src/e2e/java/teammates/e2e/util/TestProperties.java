...
public final class TestProperties {
    ...
    /** The directory where CSV files used to compare with downloaded results are stored. */
    public static final String TEST_RESULTS_FOLDER = "src/e2e/resources/results";
