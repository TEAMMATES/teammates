...
describe('SectionTypeDescriptionPipe', () => {
  ...
  it('should generate description for SectionType.BOTH', () => {
    const pipe: SectionTypeDescriptionPipe = new SectionTypeDescriptionPipe();
    expect(pipe.transform(InstructorSessionResultSectionType.BOTH)).toEqual(
  ...
  it('should generate description for SectionType.EITHER', () => {
    const pipe: SectionTypeDescriptionPipe = new SectionTypeDescriptionPipe();
    expect(pipe.transform(InstructorSessionResultSectionType.EITHER)).toEqual(
  ...
  it('should generate description for SectionType.EVALUEE', () => {
    const pipe: SectionTypeDescriptionPipe = new SectionTypeDescriptionPipe();
    expect(pipe.transform(InstructorSessionResultSectionType.EVALUEE)).toEqual(
  ...
  it('should generate description for SectionType.GIVER', () => {
    const pipe: SectionTypeDescriptionPipe = new SectionTypeDescriptionPipe();
    expect(pipe.transform(InstructorSessionResultSectionType.GIVER)).toEqual(
  ...
  it('should generate unknown for unknown SectionType', () => {
    const pipe: SectionTypeDescriptionPipe = new SectionTypeDescriptionPipe();
    expect(pipe.transform('Unknown' as InstructorSessionResultSectionType)).toEqual('Unknown');
  });
});
