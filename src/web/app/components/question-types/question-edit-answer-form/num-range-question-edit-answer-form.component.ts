...
import { NUMERICAL_RANGE_END_NOT_SUBMITTED, NUMERICAL_RANGE_START_NOT_SUBMITTED } from '../../../../types/feedback-response-details';
import { QuestionEditAnswerFormComponent } from './question-edit-answer-form';

@Component({
  selector: 'tm-num-range-question-edit-answer-form',
  templateUrl: './num-range-question-edit-answer-form.component.html',
  styleUrls: ['./num-range-question-edit-answer-form.component.scss']
})
export class NumRangeQuestionEditAnswerFormComponent
    extends QuestionEditAnswerFormComponent<FeedbackNumericalRangeQuestionDetails,
        FeedbackNumericalRangeResponseDetails> {

  readonly NUMERICAL_RANGE_START_NOT_SUBMITTED: number = NUMERICAL_RANGE_START_NOT_SUBMITTED;
  readonly NUMERICAL_RANGE_END_NOT_SUBMITTED: number = NUMERICAL_RANGE_END_NOT_SUBMITTED;

  constructor() {
    super(DEFAULT_NUMRANGE_QUESTION_DETAILS(), DEFAULT_NUMRANGE_RESPONSE_DETAILS());
  }
