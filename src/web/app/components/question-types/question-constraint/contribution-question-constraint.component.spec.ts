...
describe('ContributionQuestionConstraintComponent', () => {
  ...
  it('totalRequiredContributions: should return the correct total required contributions based on the number of forms', () => {
    const recipientSubmissionForms: FeedbackResponseRecipientSubmissionFormModel[] = [
      formBuilder.build(),
      formBuilder.build(),
      formBuilder.build()
  ...
  it('isAllContributionsDistributed: should return true when total answered contributions equal total required contributions', () => {
  ...
  it('isAllContributionsDistributed: should return false when total answered contributions do not equal total required contributions', () => {
  ...
  it('isInsufficientContributionsDistributed: should return true when total answered contributions are less than total required contributions', () => {
    const answerOne = detailsBuilder.answer(30).build();
    const answerTwo = detailsBuilder.answer(50).build();
    const answerThree = detailsBuilder.answer(20).build();
  ...
  it('isInsufficientContributionsDistributed: should return false when total answered contributions are equal to total required contributions', () => {
    const answerOne = detailsBuilder.answer(110).build();
    const answerTwo = detailsBuilder.answer(90).build();
    const answerThree = detailsBuilder.answer(100).build();
  ...
  it('isContributionsOverAllocated: should return true when total answered contributions are greater than total required contributions', () => {
    const answerOne = detailsBuilder.answer(110).build();
    const answerTwo = detailsBuilder.answer(90).build();
  ...
  it('isContributionsOverAllocated: should return false when total answered contributions are less than total required contributions', () => {
    const answerOne = detailsBuilder.answer(30).build();
    const answerTwo = detailsBuilder.answer(50).build();
    const answerThree = detailsBuilder.answer(20).build();
  ...
  it('currentTotalString: should return correct string when total answered contributions are equal to a multiple of 100', () => {
  ...
  it('currentTotalString: should return correct string when total answered contributions are greater than required', () => {
  ...
  it('currentTotalString: should return correct string when total answered contributions are less than required', () => {
    const answerOne = detailsBuilder.answer(100).build();
    const answerTwo = detailsBuilder.answer(50).build();
