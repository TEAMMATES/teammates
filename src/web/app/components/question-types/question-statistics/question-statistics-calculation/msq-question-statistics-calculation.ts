...
export class MsqQuestionStatisticsCalculation
  ...
  calculateStatistics(): void {
    ...
    for (const response of this.responses) {
      ...
      recipientEmails[email] = recipientEmails[email] || email || defaultRecipientEmail;
    ...
    for (const response of this.responses) {
      ...
      const recipientResponse = perRecipientResponse[responseEmail];
      this.updateResponseCountPerOptionForResponse(response.responseDetails, recipientResponse);
