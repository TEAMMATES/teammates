...
export class FeedbackPathPanelComponent implements OnInit {
  ...
  @Output()
  changeGiverRecipientTypeEvent: EventEmitter<{giverType: FeedbackParticipantType, recipientType:FeedbackParticipantType}> = new EventEmitter<{giverType: FeedbackParticipantType, recipientType:FeedbackParticipantType}>();
