...
import { AccountRequest, AccountRequestStatus, Email, RegenerateKey } from '../../../types/api-output';
...
export class AdminSearchPageComponent {
  ...
  /**
   * Opens a modal containing the panel for managing the account request.
   */
