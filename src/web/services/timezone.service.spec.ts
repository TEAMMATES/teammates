...
describe('TimezoneService', () => {
  ...
  it('should resolve local date time: DST springing forward', () => {
    ...
    expect(usTime === baseEpochTime + MsConst.ONE_HOUR_MILLISECONDS || usTime === baseEpochTime).toBeTruthy();
    ...
    expect(usTime).toEqual(baseEpochTime + MsConst.ONE_HOUR_MILLISECONDS);
    ...
    expect(usTime).toEqual(baseEpochTime + 2 * MsConst.ONE_HOUR_MILLISECONDS);
  ...
  it('should resolve local date time: DST springing backward', () => {
    ...
    expect(usTime === baseEpochTime + MsConst.ONE_HOUR_MILLISECONDS
      || usTime === baseEpochTime + 2 * MsConst.ONE_HOUR_MILLISECONDS)
      .toBeTruthy();
    ...
    expect(usTime).toEqual(baseEpochTime + 3 * MsConst.ONE_HOUR_MILLISECONDS);
