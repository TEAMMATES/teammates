...
export class CourseService {
  ...
  /**
   * Get student courses data of a given account id in masquerade mode by calling API.
   */
  ...
  /**
   * Get instructor courses data of a given account id in masquerade mode by calling API.
   */
