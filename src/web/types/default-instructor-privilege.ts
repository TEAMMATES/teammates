 ...
 */
export const DEFAULT_PRIVILEGE_COOWNER: () => InstructorPermissionSet = (): InstructorPermissionSet => {
 ...
 */
export const DEFAULT_PRIVILEGE_MANAGER: () => InstructorPermissionSet = (): InstructorPermissionSet => {
 ...
 */
export const DEFAULT_PRIVILEGE_OBSERVER: () => InstructorPermissionSet = (): InstructorPermissionSet => {
 ...
 */
export const DEFAULT_PRIVILEGE_TUTOR: () => InstructorPermissionSet = (): InstructorPermissionSet => {
 ...
 */
export const DEFAULT_INSTRUCTOR_PRIVILEGE: () => InstructorPermissionSet = (): InstructorPermissionSet => {
