 ...
 */
export const DEFAULT_TEXT_QUESTION_DETAILS: () => FeedbackTextQuestionDetails = (): FeedbackTextQuestionDetails => {
 ...
 */
export const DEFAULT_TEXT_RESPONSE_DETAILS: () => FeedbackTextResponseDetails = (): FeedbackTextResponseDetails => {
 ...
 */
export const DEFAULT_MCQ_QUESTION_DETAILS: () => FeedbackMcqQuestionDetails = (): FeedbackMcqQuestionDetails => {
 ...
 */
export const DEFAULT_MCQ_RESPONSE_DETAILS: () => FeedbackMcqResponseDetails = (): FeedbackMcqResponseDetails => {
 ...
 */
export const DEFAULT_MSQ_QUESTION_DETAILS: () => FeedbackMsqQuestionDetails = (): FeedbackMsqQuestionDetails => {
 ...
 */
export const DEFAULT_MSQ_RESPONSE_DETAILS: () => FeedbackMsqResponseDetails = (): FeedbackMsqResponseDetails => {
