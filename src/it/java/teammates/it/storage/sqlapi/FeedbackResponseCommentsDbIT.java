...
public class FeedbackResponseCommentsDbIT extends BaseTestCaseWithSqlDatabaseAccess {
    ...
    public void testUpdateFeedbackResponseComment_singleFieldUpdate_shouldUpdateCorrectly() throws Exception {
        ...
        ______TS("Change and update giver type field");
        FeedbackParticipantType newGiverTypeToSet = FeedbackParticipantType.INSTRUCTORS;
        assertNotEquals(newGiverTypeToSet, typicalComment.getGiverSection());
        typicalComment.setGiverType(newGiverTypeToSet);
        ...
        assertEquals(newGiverTypeToSet, updatedComment.getGiverType());
        assertEquals(newGiverTypeToSet, actualComment.getGiverType());
        ...
        assertNotEquals(newIsCommentFromFeedbackParticipant, typicalComment.getIsCommentFromFeedbackParticipant());
        typicalComment.setIsCommentFromFeedbackParticipant(newIsCommentFromFeedbackParticipant);
        updatedComment = frcDb.updateFeedbackResponseComment(typicalComment);
        actualComment = frcDb.getFeedbackResponseComment(typicalComment.getId());
        assertEquals(newIsCommentFromFeedbackParticipant, updatedComment.getIsCommentFromFeedbackParticipant());
        assertEquals(newIsCommentFromFeedbackParticipant, actualComment.getIsCommentFromFeedbackParticipant());
