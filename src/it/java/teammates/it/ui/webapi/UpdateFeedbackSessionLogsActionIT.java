...
public class UpdateFeedbackSessionLogsActionIT extends BaseActionIT<UpdateFeedbackSessionLogsAction> {
    ...
    protected void testExecute() {
        ...
        // Different Types
        mockLogsProcessor.insertFeedbackSessionLog(course1.getId(), student1InCourse1.getId(), student1InCourse1.getEmail(),
        ...
        mockLogsProcessor.insertFeedbackSessionLog(course1.getId(), student2InCourse1.getId(), student2InCourse1.getEmail(),
                session1InCourse1.getId(), session1InCourse1.getName(), FeedbackSessionLogType.ACCESS.getLabel(),
                startTime.plusSeconds(900).toEpochMilli());
        ...
        mockLogsProcessor.insertFeedbackSessionLog(course3.getId(), student1InCourse3.getId(), student1InCourse3.getEmail(),
        ...
        List<FeedbackSessionLog> actual = logic.getOrderedFeedbackSessionLogs(course1.getId(), null, null, startTime, endTime);
        List<FeedbackSessionLog> actualCourse3 = logic.getOrderedFeedbackSessionLogs(course3.getId(), null, null, startTime, endTime);
    ...
    protected void testExecute_recentLogsWithSpam_someLogsCreated() {
        ...
        expected.add(new FeedbackSessionLogEntry(course1.getId(), student1InCourse1.getId(), student1InCourse1.getEmail(),
                session1InCourse1.getId(), session1InCourse1.getName(), FeedbackSessionLogType.ACCESS.getLabel(),
                startTime.toEpochMilli()));
        expected.add(new FeedbackSessionLogEntry(course1.getId(), student1InCourse1.getId(), student1InCourse1.getEmail(),
                session1InCourse1.getId(), session1InCourse1.getName(), FeedbackSessionLogType.ACCESS.getLabel(),
